...
With no flags it targets the default embedded API port and opens a browser that is already signed in as the seeded admin user; there is no login screen.
