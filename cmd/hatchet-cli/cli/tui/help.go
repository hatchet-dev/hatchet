...
func (v *HelpView) renderHelpContent() string {
	...
	b.WriteString("\n")
	b.WriteString(contentStyle.Render(commandStyle.Render("shift+tab") + "       " + descStyle.Render("Switch between primary views (Runs, Workflows, Workers)")))
	b.WriteString("\n")
	...
	b.WriteString("\n")
	b.WriteString(contentStyle.Render(commandStyle.Render("n") + "              " + descStyle.Render("Next page (when available)")))
	b.WriteString("\n")
	b.WriteString(contentStyle.Render(commandStyle.Render("p") + "              " + descStyle.Render("Previous page (when available)")))
	b.WriteString("\n")
	...
	b.WriteString("\n")
	b.WriteString(contentStyle.Render(commandStyle.Render("p") + "              " + descStyle.Render("Switch profile")))
	b.WriteString("\n")
