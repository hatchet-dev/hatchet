...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE 'Creating partition: %', create_sql;
        EXECUTE create_sql;
    END LOOP;
END $$;
...
ALTER TABLE v1_events_olap_new
RENAME TO v1_events_olap;

-- Dynamically rename partitions
DO $$
DECLARE
    partition_record RECORD;
    rename_sql TEXT;
...
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE 'Renaming partition: %', rename_sql;
        EXECUTE rename_sql;
    END LOOP;
END $$;
