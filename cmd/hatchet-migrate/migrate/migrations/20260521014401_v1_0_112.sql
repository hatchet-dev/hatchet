...
SELECT create_v1_range_partition('v1_payloads_olap_offloaded_block_index', NOW()::DATE);
SELECT create_v1_range_partition('v1_payloads_olap_offloaded_block_index', (NOW() - INTERVAL '1 day')::DATE);
SELECT create_v1_range_partition('v1_payloads_olap_offloaded_block_index', (NOW() + INTERVAL '1 day')::DATE);
SELECT create_v1_range_partition('v1_payloads_olap_offloaded_block_index', (NOW() + INTERVAL '2 day')::DATE);
-- +goose StatementEnd
