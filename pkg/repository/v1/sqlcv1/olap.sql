...
WITH lookup_data AS (
    ...
    WHERE external_id = @workflowRunExternalId::uuid
),
runs AS (
    SELECT
        lt.dag_id AS dag_id,
...
relevant_events AS (
    ...
    CROSS JOIN LATERAL (
        SELECT * FROM v1_task_events_olap e
