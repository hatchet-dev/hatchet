...
SELECT
    ...
    CASE
        WHEN $3::BOOLEAN THEN
            create_v1_olap_partition_with_date_and_status('v1_events_olap'::text, $2::date)
        ELSE 0
    END,
    CASE
        WHEN $3::BOOLEAN THEN
            create_v1_olap_partition_with_date_and_status('v1_event_to_run_olap'::text, $2::date)
        ELSE 0
    END,
