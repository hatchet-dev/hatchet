...
CREATE TABLE "_ActionToWorker" (
    ...
    CONSTRAINT "_ActionToWorker_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_StepOrder" (
    ...
    CONSTRAINT "_StepOrder_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_StepRunOrder" (
    ...
    CONSTRAINT "_StepRunOrder_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_WorkflowToWorkflowTag" (
    ...
    CONSTRAINT "_WorkflowToWorkflowTag_AB_pkey" PRIMARY KEY ("A","B")
);
