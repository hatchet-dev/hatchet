...
type EventEngineRepository interface {
	...
	SoftDeleteExpiredEvents(ctx context.Context, tenantId string, before time.Time) (int, int, error)
	...
	ClearEventPayloadData(ctx context.Context, tenantId string) (int, int, error)
}
