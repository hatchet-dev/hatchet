...
type QueueRepository interface {
	...
	GetDesiredLabels(ctx context.Context, tx *OptimisticTx, stepIds []uuid.UUID, stepIdsToLabelsFromTrigger map[uuid.UUID]*sqlcv1.GetDesiredLabelsRow) (map[uuid.UUID][]*sqlcv1.GetDesiredLabelsRow, error)
