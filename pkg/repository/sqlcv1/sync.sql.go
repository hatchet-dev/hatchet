...
const syncUpsertSlackWebhook = `-- name: SyncUpsertSlackWebhook :one
...
type SyncUpsertSlackWebhookParams struct {
	ID          uuid.UUID        `json:"id"`
...
func (q *Queries) SyncUpsertSlackWebhook(ctx context.Context, db DBTX, arg SyncUpsertSlackWebhookParams) (*SlackAppWebhook, error) {
	row := db.QueryRow(ctx, syncUpsertSlackWebhook,
		arg.ID,
		arg.Createdat,
		arg.Updatedat,
		arg.Tenantid,
