...
WITH inputs AS (
    ...
    SELECT tenant_id, id, inserted_at, readable_status, latest_retry_count, external_id, latest_worker_id, workflow_id, is_dag_task, new_readable_status, new_retry_count, new_worker_id
