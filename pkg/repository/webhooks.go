...
type WebhookRepository interface {
	...
	UpdateWebhook(ctx context.Context, tenantId string, webhookName string, opts UpdateWebhookOpts) (*sqlcv1.V1IncomingWebhook, error)
}
...
func (r *webhookRepository) UpdateWebhook(ctx context.Context, tenantId string, webhookName string, opts UpdateWebhookOpts) (*sqlcv1.V1IncomingWebhook, error) {
