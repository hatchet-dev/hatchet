...
func NewSchedulingPool(repo v1.SchedulerRepository, workflowRepo v1.WorkflowRepository, taskRepo v1.TaskRepository, l *zerolog.Logger, singleQueueLimit int, schedulerConcurrencyRateLimit int) (*SchedulingPool, func() error, error) {
