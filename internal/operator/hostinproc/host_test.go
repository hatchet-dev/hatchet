...
func (h *testHost) claimedRow() *sqlcv1.V1Operator {
	return h.operators.Put(&sqlcv1.V1Operator{ID: uuid.New(), TenantID: h.tenant.ID, Name: "dag", Kind: sqlcv1.V1OperatorKindDAG, LeasingManager: sqlcv1.V1OperatorLeasingManagerDISPATCHER, Config: []byte(`{}`)})
}
...
func TestOpenByName(t *testing.T) {
	...
	assert.Equal(t, sqlcv1.V1OperatorLeasingManagerSELF, op.LeasingManager, "the leasing defaults to SELF")
