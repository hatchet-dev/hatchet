...
type BaseMatchCondition struct {
	...
	ReadableDataKey string `protobuf:"bytes,1,opt,name=readableDataKey,proto3" json:"readableDataKey,omitempty"`
	Action          Action `protobuf:"varint,2,opt,name=action,proto3,enum=v1.Action" json:"action,omitempty"`
	OrGroupId       string `protobuf:"bytes,3,opt,name=orGroupId,proto3" json:"orGroupId,omitempty"` // a UUID defining the OR group for this condition
...
type ParentOverrideMatchCondition struct {
	...
	ParentReadableId string              `protobuf:"bytes,2,opt,name=parentReadableId,proto3" json:"parentReadableId,omitempty"`
}
...
type SleepMatchCondition struct {
	...
	Base     *BaseMatchCondition `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	SleepFor string              `protobuf:"bytes,2,opt,name=sleepFor,proto3" json:"sleepFor,omitempty"` // a duration string indicating how long to sleep
}
...
type UserEventMatchCondition struct {
	...
	Base         *BaseMatchCondition `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	UserEventKey string              `protobuf:"bytes,2,opt,name=userEventKey,proto3" json:"userEventKey,omitempty"`
}
...
type TaskConditions struct {
	...
	ParentOverrideConditions []*ParentOverrideMatchCondition `protobuf:"bytes,1,rep,name=parentOverrideConditions,proto3" json:"parentOverrideConditions,omitempty"`
	SleepConditions          []*SleepMatchCondition          `protobuf:"bytes,2,rep,name=sleepConditions,proto3" json:"sleepConditions,omitempty"`
	UserEventConditions      []*UserEventMatchCondition      `protobuf:"bytes,3,rep,name=userEventConditions,proto3" json:"userEventConditions,omitempty"`
}
...
type DurableEventListenerConditions struct {
	...
	SleepConditions     []*SleepMatchCondition     `protobuf:"bytes,1,rep,name=sleepConditions,proto3" json:"sleepConditions,omitempty"`
	UserEventConditions []*UserEventMatchCondition `protobuf:"bytes,2,rep,name=userEventConditions,proto3" json:"userEventConditions,omitempty"`
}
...
var file_v1_shared_condition_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_v1_shared_condition_proto_depIdxs = []int32{
	...
	2, // 4: v1.TaskConditions.parentOverrideConditions:type_name -> v1.ParentOverrideMatchCondition
	3, // 5: v1.TaskConditions.sleepConditions:type_name -> v1.SleepMatchCondition
	4, // 6: v1.TaskConditions.userEventConditions:type_name -> v1.UserEventMatchCondition
	3, // 7: v1.DurableEventListenerConditions.sleepConditions:type_name -> v1.SleepMatchCondition
	4, // 8: v1.DurableEventListenerConditions.userEventConditions:type_name -> v1.UserEventMatchCondition
