...
var file_v1_dispatcher_proto_rawDesc = []byte{
	...
	0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x22, 0xf9, 0x01, 0x0a, 0x12, 0x44, 0x75, 0x72, 0x61, 0x62,
	...
	0x67, 0x65, 0x22, 0x91, 0x02, 0x0a, 0x13, 0x44, 0x75, 0x72, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x61,
	...
	0x31, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x43, 0x61, 0x6c,
	0x6c, 0x62, 0x61, 0x63, 0x6b, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x48, 0x00, 0x52, 0x11, 0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61,
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x2a, 0xb0, 0x01, 0x0a, 0x14, 0x44, 0x75, 0x72, 0x61, 0x62,
	...
	0x4e, 0x44, 0x5f, 0x4d, 0x45, 0x4d, 0x4f, 0x10, 0x03, 0x32, 0x84, 0x02, 0x0a, 0x0c, 0x56, 0x31,
...
var file_v1_dispatcher_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_v1_dispatcher_proto_goTypes = []interface{}{
	...
	(*DurableTaskRequest)(nil),                   // 7: v1.DurableTaskRequest
	(*DurableTaskResponse)(nil),                  // 8: v1.DurableTaskResponse
	(*RegisterDurableEventRequest)(nil),          // 9: v1.RegisterDurableEventRequest
	(*RegisterDurableEventResponse)(nil),         // 10: v1.RegisterDurableEventResponse
	(*ListenForDurableEventRequest)(nil),         // 11: v1.ListenForDurableEventRequest
	(*DurableEvent)(nil),                         // 12: v1.DurableEvent
	(*DurableEventListenerConditions)(nil),       // 13: v1.DurableEventListenerConditions
	(*TriggerWorkflowRequest)(nil),               // 14: v1.TriggerWorkflowRequest
}
var file_v1_dispatcher_proto_depIdxs = []int32{
	0,  // 0: v1.DurableTaskEventRequest.kind:type_name -> v1.DurableTaskEventKind
	13, // 1: v1.DurableTaskEventRequest.wait_for_conditions:type_name -> v1.DurableEventListenerConditions
	14, // 2: v1.DurableTaskEventRequest.trigger_opts:type_name -> v1.TriggerWorkflowRequest
	...
	6,  // 5: v1.DurableTaskRequest.evict_invocation:type_name -> v1.DurableTaskEvictInvocationRequest
	...
	5,  // 8: v1.DurableTaskResponse.callback_completed:type_name -> v1.DurableTaskCallbackCompletedResponse
	13, // 9: v1.RegisterDurableEventRequest.conditions:type_name -> v1.DurableEventListenerConditions
	7,  // 10: v1.V1Dispatcher.DurableTask:input_type -> v1.DurableTaskRequest
	9,  // 11: v1.V1Dispatcher.RegisterDurableEvent:input_type -> v1.RegisterDurableEventRequest
	11, // 12: v1.V1Dispatcher.ListenForDurableEvent:input_type -> v1.ListenForDurableEventRequest
	8,  // 13: v1.V1Dispatcher.DurableTask:output_type -> v1.DurableTaskResponse
	10, // 14: v1.V1Dispatcher.RegisterDurableEvent:output_type -> v1.RegisterDurableEventResponse
	12, // 15: v1.V1Dispatcher.ListenForDurableEvent:output_type -> v1.DurableEvent
