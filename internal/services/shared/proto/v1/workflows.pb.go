...
type TasksFilter struct {
	...
	WorkflowIds        []string               `protobuf:"bytes,4,rep,name=workflowIds,proto3" json:"workflowIds,omitempty"`
	AdditionalMetadata []string               `protobuf:"bytes,5,rep,name=additionalMetadata,proto3" json:"additionalMetadata,omitempty"`
}
...
type CancelTasksResponse struct {
	...
	CancelledTasks []string `protobuf:"bytes,1,rep,name=cancelledTasks,proto3" json:"cancelledTasks,omitempty"`
}
...
type ReplayTasksResponse struct {
	...
	ReplayedTasks []string `protobuf:"bytes,1,rep,name=replayedTasks,proto3" json:"replayedTasks,omitempty"`
}
...
type TriggerWorkflowRunRequest struct {
	...
	AdditionalMetadata []byte `protobuf:"bytes,3,opt,name=additionalMetadata,proto3" json:"additionalMetadata,omitempty"`
...
type CreateWorkflowVersionRequest struct {
	...
	CronInput       *string          `protobuf:"bytes,8,opt,name=cronInput,proto3,oneof" json:"cronInput,omitempty"`                    // (optional) the input for the cron trigger
	OnFailureTask   *CreateTaskOpts  `protobuf:"bytes,9,opt,name=onFailureTask,proto3,oneof" json:"onFailureTask,omitempty"`            // (optional) the job to run on failure
	...
	DefaultPriority *int32           `protobuf:"varint,11,opt,name=defaultPriority,proto3,oneof" json:"defaultPriority,omitempty"`      // (optional) the default priority for the workflow
	ConcurrencyArr  []*Concurrency   `protobuf:"bytes,12,rep,name=concurrencyArr,proto3" json:"concurrencyArr,omitempty"`               // (optional) the workflow concurrency options
	DefaultFilters  []*DefaultFilter `protobuf:"bytes,13,rep,name=defaultFilters,proto3" json:"defaultFilters,omitempty"`               // (optional) the default filters for the workflow
	InputJsonSchema []byte           `protobuf:"bytes,14,opt,name=inputJsonSchema,proto3,oneof" json:"inputJsonSchema,omitempty"`       // (optional) the JSON schema for the workflow input
}
...
type Concurrency struct {
	...
	LimitStrategy *ConcurrencyLimitStrategy `protobuf:"varint,3,opt,name=limitStrategy,proto3,enum=v1.ConcurrencyLimitStrategy,oneof" json:"limitStrategy,omitempty"` // (optional) the strategy to use when the concurrency limit is reached, default CANCEL_IN_PROGRESS
}
...
type CreateTaskOpts struct {
	...
	RateLimits        []*CreateTaskRateLimit          `protobuf:"bytes,7,rep,name=rateLimits,proto3" json:"rateLimits,omitempty"`                                                                                             // (optional) the rate limits for the task
	WorkerLabels      map[string]*DesiredWorkerLabels `protobuf:"bytes,8,rep,name=workerLabels,proto3" json:"workerLabels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // (optional) the desired worker affinity state for the task
	BackoffFactor     *float32                        `protobuf:"fixed32,9,opt,name=backoffFactor,proto3,oneof" json:"backoffFactor,omitempty"`                                                                               // (optional) the retry backoff factor for the task
	BackoffMaxSeconds *int32                          `protobuf:"varint,10,opt,name=backoffMaxSeconds,proto3,oneof" json:"backoffMaxSeconds,omitempty"`                                                                       // (optional) the maximum backoff time for the task
	...
	ScheduleTimeout   *string                         `protobuf:"bytes,13,opt,name=scheduleTimeout,proto3,oneof" json:"scheduleTimeout,omitempty"`                                                                            // (optional) the timeout for the schedule
}
...
type GetRunDetailsRequest struct {
	...
	ExternalId string `protobuf:"bytes,1,opt,name=externalId,proto3" json:"externalId,omitempty"` // (required) the external id (uuid) of the workflow run
}
...
type TaskRunDetail struct {
	...
	ExternalId string    `protobuf:"bytes,1,opt,name=externalId,proto3" json:"externalId,omitempty"`            // the external id (uuid) of the task run
	...
	ReadableId string    `protobuf:"bytes,5,opt,name=readableId,proto3" json:"readableId,omitempty"`            // the readable id of the task
}
...
type GetRunDetailsResponse struct {
	...
	TaskRuns           map[string]*TaskRunDetail `protobuf:"bytes,3,rep,name=taskRuns,proto3" json:"taskRuns,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // map of task run external ids to their details
	Done               bool                      `protobuf:"varint,4,opt,name=done,proto3" json:"done,omitempty"`                                                                                                // indicates if the workflow run is done
	AdditionalMetadata []byte                    `protobuf:"bytes,5,opt,name=additionalMetadata,proto3" json:"additionalMetadata,omitempty"`                                                                     // (optional) additional metadata for the workflow run
}
...
var file_v1_workflows_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0xee, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x73,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x2e, 0x0a, 0x12, 0x61,
	0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x12, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x61, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1f, 0x0a, 0x08, 0x70,
	...
	0x5f, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x3c, 0x0a, 0x1a, 0x54, 0x72, 0x69,
	0x67, 0x67, 0x65, 0x72, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x75, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x78, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x22, 0xcd, 0x05, 0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x08, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xb3, 0x01, 0x0a, 0x0b, 0x43, 0x6f,
	...
	,
	...
	0x07, 0x5f, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xcf, 0x05, 0x0a, 0x0e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x4f, 0x70, 0x74, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x72,
	0x65, 0x61, 0x64, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x52, 0x07, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x37, 0x0a, 0x0a, 0x72, 0x61, 0x74,
	0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x88, 0x01, 0x01, 0x12, 0x2d, 0x0a, 0x0f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75,
	0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x48,
	...
	0x10, 0x0a, 0x0e, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x6f, 0x66, 0x66, 0x46, 0x61, 0x63, 0x74, 0x6f,
	0x72, 0x42, 0x14, 0x0a, 0x12, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x6f, 0x66, 0x66, 0x4d, 0x61, 0x78,
	0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x63, 0x6f, 0x6e, 0x64,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x12, 0x0a, 0x10, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x64,
	0x75, 0x6c, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xb0, 0x02, 0x0a, 0x13, 0x43,
	...
	0x1d, 0x0a, 0x07, 0x6b, 0x65, 0x79, 0x45, 0x78, 0x70, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x01, 0x52, 0x07, 0x6b, 0x65, 0x79, 0x45, 0x78, 0x70, 0x72, 0x88, 0x01, 0x01, 0x12, 0x21,
	0x0a, 0x09, 0x75, 0x6e, 0x69, 0x74, 0x73, 0x45, 0x78, 0x70, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x48, 0x02, 0x52, 0x09, 0x75, 0x6e, 0x69, 0x74, 0x73, 0x45, 0x78, 0x70, 0x72, 0x88, 0x01,
	0x01, 0x12, 0x2d, 0x0a, 0x0f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73,
	0x45, 0x78, 0x70, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03, 0x52, 0x0f, 0x6c, 0x69,
	...
	0x74, 0x73, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6b, 0x65, 0x79, 0x45, 0x78, 0x70, 0x72, 0x42, 0x0c,
	0x0a, 0x0a, 0x5f, 0x75, 0x6e, 0x69, 0x74, 0x73, 0x45, 0x78, 0x70, 0x72, 0x42, 0x12, 0x0a, 0x10,
	0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x45, 0x78, 0x70, 0x72,
	0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4f, 0x0a,
	...
	0x28, 0x09, 0x52, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x49, 0x64, 0x22, 0x36,
	...
	0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x22, 0xc3, 0x01, 0x0a, 0x0d, 0x54, 0x61, 0x73, 0x6b, 0x52,
	0x75, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x78,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	,
	...
	0x74, 0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x6f, 0x6e, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x64, 0x6f, 0x6e, 0x65, 0x12, 0x2e, 0x0a, 0x12,
	...
	0x6f, 0x6e, 0x61, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x4e, 0x0a, 0x0d,
	0x54, 0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a,
	0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12,
	0x27, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11,
	0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x24, 0x0a, 0x0e,
	...
	0x10, 0x01, 0x2a, 0x5d, 0x0a, 0x11, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x44,
	...
	0x06, 0x2a, 0x4e, 0x0a, 0x09, 0x52, 0x75, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0a,
	...
	0x04, 0x2a, 0x7f, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
	...
	0x4f, 0x52, 0x5f, 0x45, 0x51, 0x55, 0x41, 0x4c, 0x10, 0x05, 0x32, 0xfd, 0x02, 0x0a, 0x0c, 0x41,
	...
	0x6c, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69,
...
var file_v1_workflows_proto_depIdxs = []int32{
	...
	16, // 6: v1.CreateWorkflowVersionRequest.onFailureTask:type_name -> v1.CreateTaskOpts
	0,  // 7: v1.CreateWorkflowVersionRequest.sticky:type_name -> v1.StickyStrategy
	14, // 8: v1.CreateWorkflowVersionRequest.concurrencyArr:type_name -> v1.Concurrency
	13, // 9: v1.CreateWorkflowVersionRequest.defaultFilters:type_name -> v1.DefaultFilter
	3,  // 10: v1.Concurrency.limitStrategy:type_name -> v1.ConcurrencyLimitStrategy
	4,  // 11: v1.DesiredWorkerLabels.comparator:type_name -> v1.WorkerLabelComparator
	17, // 12: v1.CreateTaskOpts.rateLimits:type_name -> v1.CreateTaskRateLimit
	22, // 13: v1.CreateTaskOpts.workerLabels:type_name -> v1.CreateTaskOpts.WorkerLabelsEntry
	...
	23, // 19: v1.GetRunDetailsResponse.taskRuns:type_name -> v1.GetRunDetailsResponse.TaskRunsEntry
