...
type GetRunPayloadsResponse struct {
	...
	Output    []byte  `protobuf:"bytes,2,opt,name=output,proto3,oneof" json:"output,omitempty"`  // (optional) the output payload for the workflow run
	Completed bool    `protobuf:"varint,3,opt,name=completed,proto3" json:"completed,omitempty"` // whether the workflow run is completed
	Error     *string `protobuf:"bytes,4,opt,name=error,proto3,oneof" json:"error,omitempty"`    // (optional) error message if the workflow run failed
}
...
func (x *GetRunPayloadsResponse) GetOutput() []byte {
	if x != nil {
		return x.Output
	}
	return nil
...
func (x *GetRunPayloadsResponse) GetCompleted() bool {
	if x != nil {
		return x.Completed
	}
	return false
...
func (x *GetRunPayloadsResponse) GetError() string {
...
var file_v1_workflows_proto_rawDesc = []byte{
	...
	0x22, 0x99, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x69,
	0x6e, 0x70, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75,
	0x74, 0x12, 0x1b, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0c, 0x48, 0x00, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x88, 0x01, 0x01, 0x12, 0x1c,
	0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x05,
	...
	0x75, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2a, 0x24, 0x0a, 0x0e,
	...
	0x06, 0x2a, 0x7f, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
	...
	0x4f, 0x52, 0x5f, 0x45, 0x51, 0x55, 0x41, 0x4c, 0x10, 0x05, 0x32, 0x80, 0x03, 0x0a, 0x0c, 0x41,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6e, 0x50, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x12, 0x19, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x52,
	0x75, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x1a, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6e, 0x50, 0x61, 0x79,
	0x6c, 0x6f, 0x61, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x42, 0x5a,
...
var file_v1_workflows_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_v1_workflows_proto_goTypes = []interface{}{
	...
	(*GetRunPayloadsRequest)(nil),         // 18: v1.GetRunPayloadsRequest
	(*GetRunPayloadsResponse)(nil),        // 19: v1.GetRunPayloadsResponse
	nil,                                   // 20: v1.CreateTaskOpts.WorkerLabelsEntry
	(*timestamppb.Timestamp)(nil),         // 21: google.protobuf.Timestamp
	(*TaskConditions)(nil),                // 22: v1.TaskConditions
}
var file_v1_workflows_proto_depIdxs = []int32{
	...
	21, // 2: v1.TasksFilter.since:type_name -> google.protobuf.Timestamp
	21, // 3: v1.TasksFilter.until:type_name -> google.protobuf.Timestamp
	15, // 4: v1.CreateWorkflowVersionRequest.tasks:type_name -> v1.CreateTaskOpts
	13, // 5: v1.CreateWorkflowVersionRequest.concurrency:type_name -> v1.Concurrency
	15, // 6: v1.CreateWorkflowVersionRequest.on_failure_task:type_name -> v1.CreateTaskOpts
	...
	16, // 12: v1.CreateTaskOpts.rate_limits:type_name -> v1.CreateTaskRateLimit
	20, // 13: v1.CreateTaskOpts.worker_labels:type_name -> v1.CreateTaskOpts.WorkerLabelsEntry
	13, // 14: v1.CreateTaskOpts.concurrency:type_name -> v1.Concurrency
	22, // 15: v1.CreateTaskOpts.conditions:type_name -> v1.TaskConditions
	1,  // 16: v1.CreateTaskRateLimit.duration:type_name -> v1.RateLimitDuration
	14, // 17: v1.CreateTaskOpts.WorkerLabelsEntry.value:type_name -> v1.DesiredWorkerLabels
	11, // 18: v1.AdminService.PutWorkflow:input_type -> v1.CreateWorkflowVersionRequest
	4,  // 19: v1.AdminService.CancelTasks:input_type -> v1.CancelTasksRequest
	5,  // 20: v1.AdminService.ReplayTasks:input_type -> v1.ReplayTasksRequest
	9,  // 21: v1.AdminService.TriggerWorkflowRun:input_type -> v1.TriggerWorkflowRunRequest
	18, // 22: v1.AdminService.GetRunPayloads:input_type -> v1.GetRunPayloadsRequest
	17, // 23: v1.AdminService.PutWorkflow:output_type -> v1.CreateWorkflowVersionResponse
	...
	19, // 27: v1.AdminService.GetRunPayloads:output_type -> v1.GetRunPayloadsResponse
