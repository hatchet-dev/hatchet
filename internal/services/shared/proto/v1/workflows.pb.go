...
var file_v1_workflows_proto_rawDesc = []byte{
	...
	0x49, 0x43, 0x54, 0x45, 0x44, 0x10, 0x05, 0x2a, 0x7f, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x63, 0x75,
...
var file_v1_workflows_proto_goTypes = []interface{}{
	...
	(*CreateTaskOpts)(nil),                       // 19: v1.CreateTaskOpts
	(*CreateTaskRateLimit)(nil),                  // 20: v1.CreateTaskRateLimit
	(*CreateWorkflowVersionResponse)(nil),        // 21: v1.CreateWorkflowVersionResponse
	(*GetRunDetailsRequest)(nil),                 // 22: v1.GetRunDetailsRequest
	(*TaskRunDetail)(nil),                        // 23: v1.TaskRunDetail
	(*GetRunDetailsResponse)(nil),                // 24: v1.GetRunDetailsResponse
	nil,                                          // 25: v1.TriggerWorkflowRunRequest.DesiredWorkerLabelsEntry
	nil,                                          // 26: v1.CreateTaskOpts.WorkerLabelsEntry
	nil,                                          // 27: v1.CreateTaskOpts.SlotRequestsEntry
	nil,                                          // 28: v1.GetRunDetailsResponse.TaskRunsEntry
	(*timestamppb.Timestamp)(nil),                // 29: google.protobuf.Timestamp
	(*TaskConditions)(nil),                       // 30: v1.TaskConditions
	(*DesiredWorkerLabels)(nil),                  // 31: v1.DesiredWorkerLabels
}
var file_v1_workflows_proto_depIdxs = []int32{
	...
	29, // 2: v1.TasksFilter.since:type_name -> google.protobuf.Timestamp
	29, // 3: v1.TasksFilter.until:type_name -> google.protobuf.Timestamp
	25, // 4: v1.TriggerWorkflowRunRequest.desired_worker_labels:type_name -> v1.TriggerWorkflowRunRequest.DesiredWorkerLabelsEntry
	19, // 5: v1.CreateWorkflowVersionRequest.tasks:type_name -> v1.CreateTaskOpts
	18, // 6: v1.CreateWorkflowVersionRequest.concurrency:type_name -> v1.Concurrency
	19, // 7: v1.CreateWorkflowVersionRequest.on_failure_task:type_name -> v1.CreateTaskOpts
	...
	20, // 14: v1.CreateTaskOpts.rate_limits:type_name -> v1.CreateTaskRateLimit
	26, // 15: v1.CreateTaskOpts.worker_labels:type_name -> v1.CreateTaskOpts.WorkerLabelsEntry
	18, // 16: v1.CreateTaskOpts.concurrency:type_name -> v1.Concurrency
	30, // 17: v1.CreateTaskOpts.conditions:type_name -> v1.TaskConditions
	27, // 18: v1.CreateTaskOpts.slot_requests:type_name -> v1.CreateTaskOpts.SlotRequestsEntry
	1,  // 19: v1.CreateTaskRateLimit.duration:type_name -> v1.RateLimitDuration
	2,  // 20: v1.TaskRunDetail.status:type_name -> v1.RunStatus
	2,  // 21: v1.GetRunDetailsResponse.status:type_name -> v1.RunStatus
	28, // 22: v1.GetRunDetailsResponse.task_runs:type_name -> v1.GetRunDetailsResponse.TaskRunsEntry
	31, // 23: v1.TriggerWorkflowRunRequest.DesiredWorkerLabelsEntry.value:type_name -> v1.DesiredWorkerLabels
	31, // 24: v1.CreateTaskOpts.WorkerLabelsEntry.value:type_name -> v1.DesiredWorkerLabels
	23, // 25: v1.GetRunDetailsResponse.TaskRunsEntry.value:type_name -> v1.TaskRunDetail
	13, // 26: v1.AdminService.PutWorkflow:input_type -> v1.CreateWorkflowVersionRequest
	4,  // 27: v1.AdminService.CancelTasks:input_type -> v1.CancelTasksRequest
	5,  // 28: v1.AdminService.ReplayTasks:input_type -> v1.ReplayTasksRequest
	9,  // 29: v1.AdminService.TriggerWorkflowRun:input_type -> v1.TriggerWorkflowRunRequest
	22, // 30: v1.AdminService.GetRunDetails:input_type -> v1.GetRunDetailsRequest
	11, // 31: v1.AdminService.BranchDurableTask:input_type -> v1.BranchDurableTaskRequest
	21, // 32: v1.AdminService.PutWorkflow:output_type -> v1.CreateWorkflowVersionResponse
	7,  // 33: v1.AdminService.CancelTasks:output_type -> v1.CancelTasksResponse
	8,  // 34: v1.AdminService.ReplayTasks:output_type -> v1.ReplayTasksResponse
	10, // 35: v1.AdminService.TriggerWorkflowRun:output_type -> v1.TriggerWorkflowRunResponse
	24, // 36: v1.AdminService.GetRunDetails:output_type -> v1.GetRunDetailsResponse
	12, // 37: v1.AdminService.BranchDurableTask:output_type -> v1.BranchDurableTaskResponse
