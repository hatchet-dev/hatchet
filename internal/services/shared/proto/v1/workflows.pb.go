...
type CreateFilterRequest struct {
	...
	WorkflowId   string  `protobuf:"bytes,1,opt,name=workflowId,proto3" json:"workflowId,omitempty"`     // (required) the workflow id
	Expression   string  `protobuf:"bytes,2,opt,name=expression,proto3" json:"expression,omitempty"`     // (required) the filter (CEL) expression
	ResourceHint string  `protobuf:"bytes,3,opt,name=resourceHint,proto3" json:"resourceHint,omitempty"` // the resource hint for the filter
	Payload      *string `protobuf:"bytes,4,opt,name=payload,proto3,oneof" json:"payload,omitempty"`     // (optional) an additional payload to send as part of the matched expression
}
...
func (x *CreateFilterRequest) GetWorkflowId() string {
	if x != nil {
		return x.WorkflowId
	}
	return ""
...
func (x *CreateFilterRequest) GetExpression() string {
	if x != nil {
		return x.Expression
	}
	return ""
...
func (x *CreateFilterRequest) GetResourceHint() string {
	if x != nil {
...
func (x *CreateFilterRequest) GetPayload() string {
...
type CreateFilterResponse struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // the id of the created filter
}
...
func (x *CreateFilterResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type DeleteFilterRequest struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // (required) the id of the filter to delete
}
...
type DeleteFilterResponse struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // the id of the deleted filter
}
...
func (x *DeleteFilterResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_v1_workflows_proto_rawDesc = []byte{
	...
	0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x49, 0x64, 0x22, 0xa4, 0x01, 0x0a, 0x13, 0x43, 0x72, 0x65,
	...
	0x12, 0x22, 0x0a, 0x0c, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x48, 0x69, 0x6e, 0x74,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x48, 0x69, 0x6e, 0x74, 0x12, 0x1d, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22,
	0x26, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x2a, 0x24, 0x0a, 0x0e, 0x53, 0x74, 0x69, 0x63, 0x6b, 0x79,
	...
	0x05, 0x12, 0x08, 0x0a, 0x04, 0x59, 0x45, 0x41, 0x52, 0x10, 0x06, 0x2a, 0x7f, 0x0a, 0x18, 0x43,
	...
	0x41, 0x4c, 0x10, 0x05, 0x32, 0xbd, 0x03, 0x0a, 0x0c, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x65,
	...
	0x6c, 0x6f, 0x77, 0x52, 0x75, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41,
	0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x17,
	0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	...
	0x65, 0x12, 0x41, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x12, 0x17, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x76, 0x31, 0x2e,
...
var file_v1_workflows_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_v1_workflows_proto_goTypes = []interface{}{
	...
	(*CreateFilterRequest)(nil),           // 17: v1.CreateFilterRequest
	(*CreateFilterResponse)(nil),          // 18: v1.CreateFilterResponse
	(*DeleteFilterRequest)(nil),           // 19: v1.DeleteFilterRequest
	(*DeleteFilterResponse)(nil),          // 20: v1.DeleteFilterResponse
	nil,                                   // 21: v1.CreateTaskOpts.WorkerLabelsEntry
	(*timestamppb.Timestamp)(nil),         // 22: google.protobuf.Timestamp
	(*TaskConditions)(nil),                // 23: v1.TaskConditions
}
var file_v1_workflows_proto_depIdxs = []int32{
	...
	22, // 2: v1.TasksFilter.since:type_name -> google.protobuf.Timestamp
	22, // 3: v1.TasksFilter.until:type_name -> google.protobuf.Timestamp
	...
	21, // 12: v1.CreateTaskOpts.worker_labels:type_name -> v1.CreateTaskOpts.WorkerLabelsEntry
	12, // 13: v1.CreateTaskOpts.concurrency:type_name -> v1.Concurrency
	23, // 14: v1.CreateTaskOpts.conditions:type_name -> v1.TaskConditions
	...
	17, // 21: v1.AdminService.CreateFilter:input_type -> v1.CreateFilterRequest
	19, // 22: v1.AdminService.DeleteFilter:input_type -> v1.DeleteFilterRequest
	16, // 23: v1.AdminService.PutWorkflow:output_type -> v1.CreateWorkflowVersionResponse
	...
	18, // 27: v1.AdminService.CreateFilter:output_type -> v1.CreateFilterResponse
	20, // 28: v1.AdminService.DeleteFilter:output_type -> v1.DeleteFilterResponse
