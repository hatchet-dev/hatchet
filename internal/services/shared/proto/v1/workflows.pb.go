...
type WorkflowRunTerminalStatus int32

const (
	WorkflowRunTerminalStatus_COMPLETED WorkflowRunTerminalStatus = 0
	WorkflowRunTerminalStatus_FAILED    WorkflowRunTerminalStatus = 1
	WorkflowRunTerminalStatus_CANCELLED WorkflowRunTerminalStatus = 2
)

// Enum value maps for WorkflowRunTerminalStatus.
var (
	WorkflowRunTerminalStatus_name = map[int32]string{
		0: "COMPLETED",
		1: "FAILED",
		2: "CANCELLED",
	}
	WorkflowRunTerminalStatus_value = map[string]int32{
		"COMPLETED": 0,
		"FAILED":    1,
		"CANCELLED": 2,
	}
...
func (x WorkflowRunTerminalStatus) Enum() *WorkflowRunTerminalStatus {
	p := new(WorkflowRunTerminalStatus)
	*p = x
	return p
}

func (x WorkflowRunTerminalStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WorkflowRunTerminalStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_workflows_proto_enumTypes[2].Descriptor()
}

func (WorkflowRunTerminalStatus) Type() protoreflect.EnumType {
	return &file_v1_workflows_proto_enumTypes[2]
}

func (x WorkflowRunTerminalStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WorkflowRunTerminalStatus.Descriptor instead.
func (WorkflowRunTerminalStatus) EnumDescriptor() ([]byte, []int) {
...
type GetRunPayloadsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetRunPayloadsRequest) Reset() {
	*x = GetRunPayloadsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetRunPayloadsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRunPayloadsRequest) ProtoMessage() {}

func (x *GetRunPayloadsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_workflows_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRunPayloadsRequest.ProtoReflect.Descriptor instead.
func (*GetRunPayloadsRequest) Descriptor() ([]byte, []int) {
	return file_v1_workflows_proto_rawDescGZIP(), []int{14}
}

func (x *GetRunPayloadsRequest) GetExternalId() string {
	if x != nil {
		return x.ExternalId
	}
	return ""
...
type TaskRunDetail struct {
	...
	InTerminalState bool                       `protobuf:"varint,2,opt,name=in_terminal_state,json=inTerminalState,proto3" json:"in_terminal_state,omitempty"`                                    // whether the task run is in a terminal state
	TerminalStatus  *WorkflowRunTerminalStatus `protobuf:"varint,3,opt,name=terminal_status,json=terminalStatus,proto3,enum=v1.WorkflowRunTerminalStatus,oneof" json:"terminal_status,omitempty"` // (optional) the terminal status of the task run, if in terminal state
	Error           *string                    `protobuf:"bytes,4,opt,name=error,proto3,oneof" json:"error,omitempty"`                                                                            // (optional) error message from the task run, if any
	Output          []byte                     `protobuf:"bytes,5,opt,name=output,proto3,oneof" json:"output,omitempty"`                                                                          // (optional) the output payload for the task run
	ReadableId      string                     `protobuf:"bytes,6,opt,name=readable_id,json=readableId,proto3" json:"readable_id,omitempty"`                                                      // the readable id of the task
}
...
func (x *TaskRunDetail) GetInTerminalState() bool {
	if x != nil {
		return x.InTerminalState
	}
	return false
}

func (x *TaskRunDetail) GetTerminalStatus() WorkflowRunTerminalStatus {
	if x != nil && x.TerminalStatus != nil {
		return *x.TerminalStatus
	}
	return WorkflowRunTerminalStatus_COMPLETED
}
...
type GetRunPayloadsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Input    []byte                    `protobuf:"bytes,1,opt,name=input,proto3" json:"input,omitempty"`                                                                                                               // the input payload for the workflow run
	TaskRuns map[string]*TaskRunDetail `protobuf:"bytes,2,rep,name=task_runs,json=taskRuns,proto3" json:"task_runs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // map of task run external ids to their details
}

func (x *GetRunPayloadsResponse) Reset() {
	*x = GetRunPayloadsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetRunPayloadsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRunPayloadsResponse) ProtoMessage() {}

func (x *GetRunPayloadsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_workflows_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRunPayloadsResponse.ProtoReflect.Descriptor instead.
func (*GetRunPayloadsResponse) Descriptor() ([]byte, []int) {
	return file_v1_workflows_proto_rawDescGZIP(), []int{16}
}

func (x *GetRunPayloadsResponse) GetInput() []byte {
	if x != nil {
		return x.Input
	}
	return nil
...
func (x *GetRunPayloadsResponse) GetTaskRuns() map[string]*TaskRunDetail {
	if x != nil {
		return x.TaskRuns
	}
	return nil
...
var file_v1_workflows_proto_rawDesc = []byte{
	...
	0x66, 0x6c, 0x6f, 0x77, 0x49, 0x64, 0x22, 0x38, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6e,
	0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x22, 0xab, 0x02, 0x0a, 0x0d, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e, 0x44, 0x65, 0x74, 0x61,
	...
	,
	...
	0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x02, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75,
	0x74, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x61, 0x64, 0x61, 0x62, 0x6c, 0x65,
	0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x72, 0x65, 0x61, 0x64, 0x61,
	0x62, 0x6c, 0x65, 0x49, 0x64, 0x42, 0x12, 0x0a, 0x10, 0x5f, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e,
	0x61, 0x6c, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xc5,
	0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	...
	0x45, 0x0a, 0x09, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x72, 0x75, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x28, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x75, 0x6e, 0x50, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x54,
	0x61, 0x73, 0x6b, 0x52, 0x75, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x08, 0x74, 0x61,
	0x73, 0x6b, 0x52, 0x75, 0x6e, 0x73, 0x1a, 0x4e, 0x0a, 0x0d, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x75,
	...
	0x05, 0x12, 0x08, 0x0a, 0x04, 0x59, 0x45, 0x41, 0x52, 0x10, 0x06, 0x2a, 0x45, 0x0a, 0x19, 0x57,
	0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x52, 0x75, 0x6e, 0x54, 0x65, 0x72, 0x6d, 0x69, 0x6e,
	0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0d, 0x0a, 0x09, 0x43, 0x4f, 0x4d, 0x50,
	...
	0x5f, 0x4f, 0x52, 0x5f, 0x45, 0x51, 0x55, 0x41, 0x4c, 0x10, 0x05, 0x32, 0x80, 0x03, 0x0a, 0x0c,
	0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x52, 0x0a, 0x0b,
	0x50, 0x75, 0x74, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x12, 0x20, 0x2e, 0x76, 0x31,
	...
	,
...
var file_v1_workflows_proto_goTypes = []interface{}{
	...
	(WorkflowRunTerminalStatus)(0),        // 2: v1.WorkflowRunTerminalStatus
	...
	(*GetRunPayloadsRequest)(nil),         // 19: v1.GetRunPayloadsRequest
	(*TaskRunDetail)(nil),                 // 20: v1.TaskRunDetail
	(*GetRunPayloadsResponse)(nil),        // 21: v1.GetRunPayloadsResponse
	nil,                                   // 22: v1.CreateTaskOpts.WorkerLabelsEntry
	nil,                                   // 23: v1.GetRunPayloadsResponse.TaskRunsEntry
...
var file_v1_workflows_proto_depIdxs = []int32{
	...
	2,  // 17: v1.TaskRunDetail.terminal_status:type_name -> v1.WorkflowRunTerminalStatus
	23, // 18: v1.GetRunPayloadsResponse.task_runs:type_name -> v1.GetRunPayloadsResponse.TaskRunsEntry
	15, // 19: v1.CreateTaskOpts.WorkerLabelsEntry.value:type_name -> v1.DesiredWorkerLabels
	20, // 20: v1.GetRunPayloadsResponse.TaskRunsEntry.value:type_name -> v1.TaskRunDetail
	12, // 21: v1.AdminService.PutWorkflow:input_type -> v1.CreateWorkflowVersionRequest
	5,  // 22: v1.AdminService.CancelTasks:input_type -> v1.CancelTasksRequest
	6,  // 23: v1.AdminService.ReplayTasks:input_type -> v1.ReplayTasksRequest
	10, // 24: v1.AdminService.TriggerWorkflowRun:input_type -> v1.TriggerWorkflowRunRequest
	19, // 25: v1.AdminService.GetRunPayloads:input_type -> v1.GetRunPayloadsRequest
	18, // 26: v1.AdminService.PutWorkflow:output_type -> v1.CreateWorkflowVersionResponse
	8,  // 27: v1.AdminService.CancelTasks:output_type -> v1.CancelTasksResponse
	9,  // 28: v1.AdminService.ReplayTasks:output_type -> v1.ReplayTasksResponse
	11, // 29: v1.AdminService.TriggerWorkflowRun:output_type -> v1.TriggerWorkflowRunResponse
	21, // 30: v1.AdminService.GetRunPayloads:output_type -> v1.GetRunPayloadsResponse
...
func file_v1_workflows_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_workflows_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRunPayloadsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_workflows_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRunPayloadsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
