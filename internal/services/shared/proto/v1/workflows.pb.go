...
type CreateFilterResponse struct {
	...
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // the id of the created filter
}
...
func (x *CreateFilterResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type DeleteFilterRequest struct {
	...
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // (required) the id of the filter to delete
}
...
type DeleteFilterResponse struct {
	...
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // the id of the deleted filter
}
...
func (x *DeleteFilterResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_v1_workflows_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x2a, 0x24, 0x0a, 0x0e, 0x53, 0x74, 0x69, 0x63, 0x6b, 0x79,
