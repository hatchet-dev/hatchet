...
type CreateTaskOpts struct {
	...
	RateLimits        []*CreateTaskRateLimit          `protobuf:"bytes,7,rep,name=rateLimits,proto3" json:"rateLimits,omitempty"`                                                                                             // (optional) the rate limits for the step
	WorkerLabels      map[string]*DesiredWorkerLabels `protobuf:"bytes,8,rep,name=workerLabels,proto3" json:"workerLabels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // (optional) the desired worker affinity state for the step
	BackoffFactor     *float32                        `protobuf:"fixed32,9,opt,name=backoffFactor,proto3,oneof" json:"backoffFactor,omitempty"`                                                                               // (optional) the retry backoff factor for the step
	BackoffMaxSeconds *int32                          `protobuf:"varint,10,opt,name=backoffMaxSeconds,proto3,oneof" json:"backoffMaxSeconds,omitempty"`                                                                       // (optional) the maximum backoff time for the step
