...
var file_dispatcher_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x72, 0x61, 0x22, 0x93, 0x03, 0x0a, 0x15, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x52,
...
var file_dispatcher_proto_depIdxs = []int32{
	...
	1,  // 4: AssignedAction.action_type:type_name -> ActionType
	35, // 5: GroupKeyActionEvent.event_timestamp:type_name -> google.protobuf.Timestamp
	2,  // 6: GroupKeyActionEvent.event_type:type_name -> GroupKeyActionEventType
	35, // 7: StepActionEvent.event_timestamp:type_name -> google.protobuf.Timestamp
	3,  // 8: StepActionEvent.event_type:type_name -> StepActionEventType
	4,  // 9: WorkflowEvent.resource_type:type_name -> ResourceType
	5,  // 10: WorkflowEvent.event_type:type_name -> ResourceEventType
	35, // 11: WorkflowEvent.event_timestamp:type_name -> google.protobuf.Timestamp
	6,  // 12: WorkflowRunEvent.event_type:type_name -> WorkflowRunEventType
	35, // 13: WorkflowRunEvent.event_timestamp:type_name -> google.protobuf.Timestamp
	24, // 14: WorkflowRunEvent.results:type_name -> StepRunResult
	35, // 15: HeartbeatRequest.heartbeat_at:type_name -> google.protobuf.Timestamp
	35, // 16: RefreshTimeoutResponse.timeout_at:type_name -> google.protobuf.Timestamp
