...
var file_dispatcher_proto_rawDesc = []byte{
	...
	0x4e, 0x49, 0x53, 0x48, 0x45, 0x44, 0x10, 0x00, 0x32, 0xeb, 0x05, 0x0a, 0x0a, 0x44, 0x69, 0x73,
...
var file_dispatcher_proto_depIdxs = []int32{
	...
	26, // 12: RefreshTimeoutResponse.timeoutAt:type_name -> google.protobuf.Timestamp
	...
	7,  // 24: Dispatcher.Register:output_type -> WorkerRegisterResponse
	8,  // 25: Dispatcher.Listen:output_type -> AssignedAction
	8,  // 26: Dispatcher.ListenV2:output_type -> AssignedAction
	23, // 27: Dispatcher.Heartbeat:output_type -> HeartbeatResponse
	17, // 28: Dispatcher.SubscribeToWorkflowEvents:output_type -> WorkflowEvent
	18, // 29: Dispatcher.SubscribeToWorkflowRuns:output_type -> WorkflowRunEvent
	14, // 30: Dispatcher.SendStepActionEvent:output_type -> ActionEventResponse
	14, // 31: Dispatcher.SendGroupKeyActionEvent:output_type -> ActionEventResponse
	21, // 32: Dispatcher.PutOverridesData:output_type -> OverridesDataResponse
	11, // 33: Dispatcher.Unsubscribe:output_type -> WorkerUnsubscribeResponse
	25, // 34: Dispatcher.RefreshTimeout:output_type -> RefreshTimeoutResponse
