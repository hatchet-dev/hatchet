...
func NewOLAPSignaler(mq msgqueue.MessageQueue, repo repository.EngineRepository, l *zerolog.Logger, pubBuffer *msgqueue.MQPubBuffer) *OLAPSignaler {
	return &OLAPSignaler{
		mq:        mq,
		l:         l,
		repo:      repo,
...
func (s *OLAPSignaler) SignalTasksCreated(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
...
func (s *OLAPSignaler) signalTasksCreatedAndQueued(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
...
func (s *OLAPSignaler) signalTasksCreatedAndCancelled(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
...
func (s *OLAPSignaler) signalTasksCreatedAndFailed(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
	internalEvents := make([]v1.InternalTaskEvent, 0)
...
func (s *OLAPSignaler) signalTasksCreatedAndSkipped(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
	internalEvents := make([]v1.InternalTaskEvent, 0)
...
func (s *OLAPSignaler) SignalTasksReplayedFromMatch(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
	// group tasks by initial states
	queuedTasks := make([]*sqlcv1.V1Task, 0)
	failedTasks := make([]*sqlcv1.V1Task, 0)
	cancelledTasks := make([]*sqlcv1.V1Task, 0)
...
func (s *OLAPSignaler) SignalTasksUpdated(ctx context.Context, tenantId string, tasks []*sqlcv1.V1Task) error {
	// group tasks by initial states
	queuedTasks := make([]*sqlcv1.V1Task, 0)
	failedTasks := make([]*sqlcv1.V1Task, 0)
	cancelledTasks := make([]*sqlcv1.V1Task, 0)
...
func (s *OLAPSignaler) SignalEventsCreated(ctx context.Context, tenantId string, eventIdToOpts map[string]v1.EventTriggerOpts, eventIdsToRuns map[string][]*v1.Run) error {
	...
	if err != nil {
		return fmt.Errorf("could not send pub message for SignalEventsCreated: %w", err)
	}
