...
from typing import Any, cast, Generic, TypeVar, Literal
...
class Subscription(Generic[T]):
    ...
    async def __aiter__(self) -> "Subscription":
        return self
    ...
    async def close(self) -> None:
        await self.queue.put(SentinelValue)
...
class PooledWorkflowRunListener:
    def __init__(self, config: ClientConfig):
        ...
        self.events: dict[int, Subscription] = {}
    ...
    async def subscribe(self, workflow_run_id: str) -> WorkflowRunEvent:
        ...
        try:
            ...
            self.events[subscription_id] = Subscription(
