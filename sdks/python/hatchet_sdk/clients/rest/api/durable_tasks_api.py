...
class DurableTasksApi:
    ...
    def v1_durable_task_event_log_list(
        ...
        offset: Annotated[
            Optional[StrictInt],
            Field(description="The number of event log entries to skip"),
        ] = None,
        limit: Annotated[
            Optional[StrictInt],
            Field(description="The number of event log entries to limit by"),
        ] = None,
        ...
        :type offset: int
        :param limit: The number of event log entries to limit by
        :type limit: int
