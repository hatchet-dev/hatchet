...
class DurableTasksApi:
    ...
    def v1_durable_task_event_log_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "List[V1DurableEventLogEntry]",
            "400": "APIErrors",
            "403": "APIErrors",
            "404": "APIErrors",
        }
    ...
    def v1_durable_task_event_log_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[V1DurableEventLogEntry]]:
        """List durable event log
    ...
    @validate_call
    def v1_durable_task_waits_list(
        self,
        durable_task: Annotated[
            str,
            Field(
        ...
        """List durable task in-flight waits

        Lists all currently in-flight (unsatisfied) waits for a durable task.
        ...
        _param = self._v1_durable_task_waits_list_serialize(
            durable_task=durable_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def v1_durable_task_waits_list_with_http_info(
        self,
        durable_task: Annotated[
            str,
            Field(
    ...
    @validate_call
    def v1_durable_task_waits_list_without_preload_content(
        self,
        durable_task: Annotated[
            str,
            Field(
    ...
    def _v1_durable_task_waits_list_serialize(
        self,
        durable_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/v1/stable/durable-tasks/{durable-task}/waits",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
