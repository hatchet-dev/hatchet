...
class RateLimitsApi:
    ...
    def rate_limit_delete(
        ...
        key: Annotated[StrictStr, Field(description="The limit key")],
        ...
        :type tenant: str
        :param key: The limit key (required)
        :type key: str
        ...
        _param = self._rate_limit_delete_serialize(
            tenant=tenant,
            key=key,
    ...
    @validate_call
    def rate_limit_delete_with_http_info(
        self,
        tenant: Annotated[
            str,
            Field(
    ...
    @validate_call
    def rate_limit_delete_without_preload_content(
        self,
        tenant: Annotated[
            str,
            Field(
    ...
    def _rate_limit_delete_serialize(
        self,
        tenant,
        key,
        _request_auth,
