...
class TaskApi:
    ...
    def v1_task_get_trace(
        ...
        _param = self._v1_task_get_trace_serialize(
            task=task,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def v1_task_get_trace_with_http_info(
        self,
        task: Annotated[
            str,
            Field(min_length=36, strict=True, max_length=36, description="The task id"),
    ...
    @validate_call
    def v1_task_get_trace_without_preload_content(
        self,
        task: Annotated[
            str,
            Field(min_length=36, strict=True, max_length=36, description="The task id"),
    ...
    def _v1_task_get_trace_serialize(
        self,
        task,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/v1/stable/tasks/{task}/trace",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v1_task_restore(
        ...
        _param = self._v1_task_restore_serialize(
            task=task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def v1_task_restore_with_http_info(
        self,
        task: Annotated[
            str,
            Field(min_length=36, strict=True, max_length=36, description="The task id"),
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1RestoreTaskResponse]:
        """Restore a task
    ...
    @validate_call
    def v1_task_restore_without_preload_content(
        self,
        task: Annotated[
            str,
            Field(min_length=36, strict=True, max_length=36, description="The task id"),
    ...
    def _v1_task_restore_serialize(
        self,
        task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/v1/stable/tasks/{task}/restore",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
