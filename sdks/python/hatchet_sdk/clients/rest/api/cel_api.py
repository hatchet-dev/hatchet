...
class CELApi:
    ...
    def v1_cel_debug(
        self,
        tenant: Annotated[UUID, Field(description="The tenant id")],
        v1_cel_debug_request: Annotated[V1CELDebugRequest, Field(description="The inputs to test the CEL expression against")],
