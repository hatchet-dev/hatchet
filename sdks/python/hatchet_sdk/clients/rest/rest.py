...
class RESTClientObject:
    ...
    def request(
        ...
        try:
            ...
            raise RestTLSError(status=0, reason=msg, http_method=method) from e
        except (
            ...
            raise RestConnectionError(status=0, reason=msg, http_method=method) from e
        except (
            ...
            raise RestTimeoutError(status=0, reason=msg, http_method=method) from e
            ...
            raise RestProtocolError(status=0, reason=msg, http_method=method) from e
