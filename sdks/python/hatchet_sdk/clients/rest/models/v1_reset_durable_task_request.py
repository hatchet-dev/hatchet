...
class V1ResetDurableTaskRequest(BaseModel):
    """
    ...
    task_external_id: Annotated[
        ...
        description="The external id of the durable task to reset.",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1ResetDurableTaskRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1ResetDurableTaskRequest from a dict"""
        if obj is None:
            return None
