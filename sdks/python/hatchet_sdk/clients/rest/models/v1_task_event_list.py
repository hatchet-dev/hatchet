...
class V1TaskEventList(BaseModel):
    """
    V1TaskEventList
    """ # noqa: E501
    pagination: Optional[PaginationResponse] = None
    rows: Optional[List[V1TaskEvent]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1TaskEventList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1TaskEventList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rows": [V1TaskEvent.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
