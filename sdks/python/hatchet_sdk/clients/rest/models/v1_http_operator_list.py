...
class V1HTTPOperatorList(BaseModel):
    """
    V1HTTPOperatorList
    """  # noqa: E501

    pagination: Optional[PaginationResponse] = None
    rows: Optional[List[V1HTTPOperator]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1HTTPOperatorList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1HTTPOperatorList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "rows": (
                    [V1HTTPOperator.from_dict(_item) for _item in obj["rows"]]
