...
class V1WebhookHMACAuth(BaseModel):
    ...
    algorithm: Optional[V1WebhookHMACAlgorithm] = Field(
        default=None, description="The HMAC algorithm to use for the webhook"
    )
    encoding: Optional[V1WebhookHMACEncoding] = Field(
        default=None, description="The encoding to use for the HMAC signature"
    )
    signature_header_name: Optional[StrictStr] = Field(
        default=None,
