...
class V1WorkflowRun(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metadata", "status", "startedAt", "finishedAt", "duration", "tenantId", "additionalMetadata", "displayName", "workflowId", "output", "errorMessage", "workflowVersionId", "input", "createdAt"]
