...
class V1TaskSummary(BaseModel):
    ...
    action_id: Optional[StrictStr] = Field(default=None, description="The action ID of the task.", alias="actionId")
    ...
    created_at: datetime = Field(description="The timestamp the task was created.", alias="createdAt")
    ...
    num_spawned_children: StrictInt = Field(description="The number of spawned children tasks", alias="numSpawnedChildren")
    ...
    step_id: Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]] = Field(default=None, description="The step ID of the task.", alias="stepId")
    ...
    workflow_run_external_id: StrictStr = Field(description="The external ID of the workflow run", alias="workflowRunExternalId")
    ...
    parent_task_external_id: Optional[StrictStr] = Field(default=None, description="The external ID of the parent task.", alias="parentTaskExternalId")
    __properties: ClassVar[List[str]] = ["metadata", "actionId", "retryCount", "attempt", "additionalMetadata", "children", "createdAt", "displayName", "duration", "errorMessage", "finishedAt", "input", "numSpawnedChildren", "output", "status", "startedAt", "stepId", "taskExternalId", "taskId", "taskInsertedAt", "tenantId", "type", "workflowId", "workflowName", "workflowRunExternalId", "workflowVersionId", "workflowConfig", "parentTaskExternalId"]
