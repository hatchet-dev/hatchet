...
class V1ServerlessEndpointList(BaseModel):
    """
    V1ServerlessEndpointList
    """  # noqa: E501

    pagination: Optional[PaginationResponse] = None
    rows: Optional[List[V1ServerlessEndpoint]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1ServerlessEndpointList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1ServerlessEndpointList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "rows": (
                    [V1ServerlessEndpoint.from_dict(_item) for _item in obj["rows"]]
