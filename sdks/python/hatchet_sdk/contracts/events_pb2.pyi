...
class PutLogRequest(_message.Message):
    __slots__ = ("task_run_id", "created_at", "message", "level", "metadata", "task_retry_count")
    ...
    def __init__(self, task_run_id: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., message: _Optional[str] = ..., level: _Optional[str] = ..., metadata: _Optional[str] = ..., task_retry_count: _Optional[int] = ...) -> None: ...
...
class PutStreamEventRequest(_message.Message):
    __slots__ = ("task_run_id", "created_at", "message", "metadata", "event_index")
    TASK_RUN_ID_FIELD_NUMBER: _ClassVar[int]
    CREATED_AT_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    metadata: str
    event_index: int
    def __init__(self, task_run_id: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., message: _Optional[bytes] = ..., metadata: _Optional[str] = ..., event_index: _Optional[int] = ...) -> None: ...
