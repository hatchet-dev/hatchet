...
class TriggerWorkflowRequest(_message.Message):
    __slots__ = ("name", "input", "parent_id", "parent_task_run_external_id", "child_index", "child_key", "additional_metadata", "desired_worker_id", "priority", "desired_worker_labels", "dag_parent_workflow_run_ids")
    ...
    DAG_PARENT_WORKFLOW_RUN_IDS_FIELD_NUMBER: _ClassVar[int]
    name: str
    input: str
    parent_id: str
