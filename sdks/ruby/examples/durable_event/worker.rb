...
# > Durable Event
DURABLE_EVENT_TASK = HATCHET.durable_task(name: "DurableEventTask") do |_input, ctx|
  res = ctx.wait_for(
    "event",
...
DURABLE_EVENT_TASK_WITH_FILTER = HATCHET.durable_task(name: "DurableEventWithFilterTask") do |_input, ctx|
  # !!
