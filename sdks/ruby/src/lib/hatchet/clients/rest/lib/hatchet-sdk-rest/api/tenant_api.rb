...
module HatchetSdkRest
  class TenantApi
    ...
    def alert_email_group_create_with_http_info(tenant, create_tenant_alert_email_group_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.alert_email_group_create, the character length must be great than or equal to 36.'
      end
    ...
    def alert_email_group_delete_with_http_info(alert_email_group, opts = {})
      ...
      if @api_client.config.client_side_validation && alert_email_group.to_s.length < 36
        fail ArgumentError, 'invalid value for "alert_email_group" when calling TenantApi.alert_email_group_delete, the character length must be great than or equal to 36.'
      end
    ...
    def alert_email_group_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.alert_email_group_list, the character length must be great than or equal to 36.'
      end
    ...
    def alert_email_group_update_with_http_info(alert_email_group, update_tenant_alert_email_group_request, opts = {})
      ...
      if @api_client.config.client_side_validation && alert_email_group.to_s.length < 36
        fail ArgumentError, 'invalid value for "alert_email_group" when calling TenantApi.alert_email_group_update, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_alerting_settings_get_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_alerting_settings_get, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_get_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_get, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_get_prometheus_metrics_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_get_prometheus_metrics, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_get_step_run_queue_metrics_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_get_step_run_queue_metrics, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_get_task_stats_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_get_task_stats, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_invite_create_with_http_info(tenant, create_tenant_invite_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_invite_create, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_invite_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_invite_list, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_member_delete_with_http_info(tenant, member, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_member_delete, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && member.to_s.length < 36
        fail ArgumentError, 'invalid value for "member" when calling TenantApi.tenant_member_delete, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_member_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_member_list, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_member_update_with_http_info(tenant, member, update_tenant_member_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_member_update, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && member.to_s.length < 36
        fail ArgumentError, 'invalid value for "member" when calling TenantApi.tenant_member_update, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_resource_policy_get_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_resource_policy_get, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_update_with_http_info(tenant, update_tenant_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TenantApi.tenant_update, the character length must be great than or equal to 36.'
      end
