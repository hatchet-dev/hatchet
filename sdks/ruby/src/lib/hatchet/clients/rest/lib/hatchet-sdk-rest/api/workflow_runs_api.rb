...
module HatchetSdkRest
  class WorkflowRunsApi
    ...
    def v1_durable_task_branch_with_http_info(tenant, v1_branch_durable_task_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunsApi.v1_durable_task_branch, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_create_with_http_info(tenant, v1_trigger_workflow_run_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunsApi.v1_workflow_run_create, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_display_names_list_with_http_info(tenant, external_ids, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunsApi.v1_workflow_run_display_names_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_external_ids_list_with_http_info(tenant, since, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunsApi.v1_workflow_run_external_ids_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_get_with_http_info(v1_workflow_run, opts = {})
      ...
      if @api_client.config.client_side_validation && v1_workflow_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_workflow_run" when calling WorkflowRunsApi.v1_workflow_run_get, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_get_status_with_http_info(v1_workflow_run, opts = {})
      ...
      if @api_client.config.client_side_validation && v1_workflow_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_workflow_run" when calling WorkflowRunsApi.v1_workflow_run_get_status, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_get_timings_with_http_info(v1_workflow_run, opts = {})
      ...
      if @api_client.config.client_side_validation && v1_workflow_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_workflow_run" when calling WorkflowRunsApi.v1_workflow_run_get_timings, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_list_with_http_info(tenant, since, only_tasks, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunsApi.v1_workflow_run_list, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'worker_id'].nil? && opts[:'worker_id'].to_s.length < 36
        fail ArgumentError, 'invalid value for "opts[:"worker_id"]" when calling WorkflowRunsApi.v1_workflow_run_list, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'parent_task_external_id'].nil? && opts[:'parent_task_external_id'].to_s.length < 36
        fail ArgumentError, 'invalid value for "opts[:"parent_task_external_id"]" when calling WorkflowRunsApi.v1_workflow_run_list, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'triggering_event_external_id'].nil? && opts[:'triggering_event_external_id'].to_s.length < 36
        fail ArgumentError, 'invalid value for "opts[:"triggering_event_external_id"]" when calling WorkflowRunsApi.v1_workflow_run_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_workflow_run_task_events_list_with_http_info(v1_workflow_run, opts = {})
      ...
      if @api_client.config.client_side_validation && v1_workflow_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_workflow_run" when calling WorkflowRunsApi.v1_workflow_run_task_events_list, the character length must be great than or equal to 36.'
      end
