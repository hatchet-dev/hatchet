  ...
  class V1Filter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HatchetSdkRest::V1Filter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HatchetSdkRest::V1Filter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_declarative')
        self.is_declarative = attributes[:'is_declarative']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @workflow_id.to_s.length < 36
        invalid_properties.push('invalid value for "workflow_id", the character length must be great than or equal to 36.')
      end
    ...
    def valid?
      ...
      return false if @workflow_id.to_s.length > 36
      return false if @workflow_id.to_s.length < 36
    ...
    def workflow_id=(workflow_id)
      ...
      if workflow_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "workflow_id", the character length must be great than or equal to 36.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payload == o.payload &&
          is_declarative == o.is_declarative
    end
    ...
    def hash
      [metadata, tenant_id, workflow_id, scope, expression, payload, is_declarative].hash
    end
