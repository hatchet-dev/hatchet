  ...
  class Event
    ...
    def self.openapi_types
      {
        ...
        :'tenant_id' => :'String',
        :'tenant' => :'Tenant',
        :'workflow_run_summary' => :'EventWorkflowRunSummary',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HatchetSdkRest::Event` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HatchetSdkRest::Event`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [metadata, key, tenant_id, tenant, workflow_run_summary, additional_metadata].hash
    end
