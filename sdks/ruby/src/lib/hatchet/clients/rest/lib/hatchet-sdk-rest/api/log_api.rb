...
module HatchetSdkRest
  class LogApi
    ...
    def v1_log_line_list_with_http_info(task, opts = {})
      ...
      if @api_client.config.client_side_validation && task.to_s.length < 36
        fail ArgumentError, 'invalid value for "task" when calling LogApi.v1_log_line_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_tenant_log_line_get_point_metrics_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling LogApi.v1_tenant_log_line_get_point_metrics, the character length must be great than or equal to 36.'
      end
    ...
    def v1_tenant_log_line_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling LogApi.v1_tenant_log_line_list, the character length must be great than or equal to 36.'
      end
