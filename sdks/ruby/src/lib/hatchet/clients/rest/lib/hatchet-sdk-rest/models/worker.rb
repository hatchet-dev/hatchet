...
module HatchetSdkRest
  class Worker
    ...
    def list_invalid_properties
      ...
      if !@dispatcher_id.nil? && @dispatcher_id.to_s.length < 36
        invalid_properties.push('invalid value for "dispatcher_id", the character length must be great than or equal to 36.')
      end
    ...
    def dispatcher_id=(dispatcher_id)
      ...
      if dispatcher_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "dispatcher_id", the character length must be great than or equal to 36.'
      end
