...
module HatchetSdkRest
  class WorkflowRunShape
    ...
    def list_invalid_properties
      ...
      if !@parent_id.nil? && @parent_id.to_s.length < 36
        invalid_properties.push('invalid value for "parent_id", the character length must be great than or equal to 36.')
      end
      ...
      if !@parent_step_run_id.nil? && @parent_step_run_id.to_s.length < 36
        invalid_properties.push('invalid value for "parent_step_run_id", the character length must be great than or equal to 36.')
      end
    ...
    def parent_id=(parent_id)
      ...
      if parent_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "parent_id", the character length must be great than or equal to 36.'
      end
    ...
    def parent_step_run_id=(parent_step_run_id)
      ...
      if parent_step_run_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "parent_step_run_id", the character length must be great than or equal to 36.'
      end
