...
module HatchetSdkRest
  class ObservabilityApi
    ...
    def v1_observability_get_trace_with_http_info(tenant, run_external_id, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling ObservabilityApi.v1_observability_get_trace, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && run_external_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "run_external_id" when calling ObservabilityApi.v1_observability_get_trace, the character length must be great than or equal to 36.'
      end
