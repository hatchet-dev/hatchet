...
module HatchetSdkRest
  class FilterApi
    ...
    def v1_filter_create_with_http_info(tenant, v1_create_filter_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling FilterApi.v1_filter_create, the character length must be great than or equal to 36.'
      end
    ...
    def v1_filter_delete_with_http_info(tenant, v1_filter, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling FilterApi.v1_filter_delete, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && v1_filter.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_filter" when calling FilterApi.v1_filter_delete, the character length must be great than or equal to 36.'
      end
    ...
    def v1_filter_get_with_http_info(tenant, v1_filter, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling FilterApi.v1_filter_get, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && v1_filter.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_filter" when calling FilterApi.v1_filter_get, the character length must be great than or equal to 36.'
      end
    ...
    def v1_filter_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling FilterApi.v1_filter_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_filter_update_with_http_info(tenant, v1_filter, v1_update_filter_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling FilterApi.v1_filter_update, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && v1_filter.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_filter" when calling FilterApi.v1_filter_update, the character length must be great than or equal to 36.'
      end
