...
module HatchetSdkRest
  class TaskApi
    ...
    def v1_dag_list_tasks_with_http_info(dag_ids, tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TaskApi.v1_dag_list_tasks, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_cancel_with_http_info(tenant, v1_cancel_task_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TaskApi.v1_task_cancel, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_event_list_with_http_info(task, opts = {})
      ...
      if @api_client.config.client_side_validation && task.to_s.length < 36
        fail ArgumentError, 'invalid value for "task" when calling TaskApi.v1_task_event_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_get_with_http_info(task, opts = {})
      ...
      if @api_client.config.client_side_validation && task.to_s.length < 36
        fail ArgumentError, 'invalid value for "task" when calling TaskApi.v1_task_get, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_get_point_metrics_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TaskApi.v1_task_get_point_metrics, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_list_status_metrics_with_http_info(tenant, since, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TaskApi.v1_task_list_status_metrics, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'parent_task_external_id'].nil? && opts[:'parent_task_external_id'].to_s.length < 36
        fail ArgumentError, 'invalid value for "opts[:"parent_task_external_id"]" when calling TaskApi.v1_task_list_status_metrics, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'triggering_event_external_id'].nil? && opts[:'triggering_event_external_id'].to_s.length < 36
        fail ArgumentError, 'invalid value for "opts[:"triggering_event_external_id"]" when calling TaskApi.v1_task_list_status_metrics, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_replay_with_http_info(tenant, v1_replay_task_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling TaskApi.v1_task_replay, the character length must be great than or equal to 36.'
      end
    ...
    def v1_task_restore_with_http_info(task, opts = {})
      ...
      if @api_client.config.client_side_validation && task.to_s.length < 36
        fail ArgumentError, 'invalid value for "task" when calling TaskApi.v1_task_restore, the character length must be great than or equal to 36.'
      end
