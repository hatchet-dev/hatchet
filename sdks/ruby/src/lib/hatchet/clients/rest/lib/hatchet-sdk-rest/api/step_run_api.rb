...
module HatchetSdkRest
  class StepRunApi
    ...
    def step_run_get_with_http_info(tenant, step_run, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling StepRunApi.step_run_get, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && step_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_run" when calling StepRunApi.step_run_get, the character length must be great than or equal to 36.'
      end
    ...
    def step_run_get_schema_with_http_info(tenant, step_run, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling StepRunApi.step_run_get_schema, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && step_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_run" when calling StepRunApi.step_run_get_schema, the character length must be great than or equal to 36.'
      end
    ...
    def step_run_list_archives_with_http_info(step_run, opts = {})
      ...
      if @api_client.config.client_side_validation && step_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_run" when calling StepRunApi.step_run_list_archives, the character length must be great than or equal to 36.'
      end
    ...
    def step_run_list_events_with_http_info(step_run, opts = {})
      ...
      if @api_client.config.client_side_validation && step_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_run" when calling StepRunApi.step_run_list_events, the character length must be great than or equal to 36.'
      end
    ...
    def step_run_update_cancel_with_http_info(tenant, step_run, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling StepRunApi.step_run_update_cancel, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && step_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_run" when calling StepRunApi.step_run_update_cancel, the character length must be great than or equal to 36.'
      end
    ...
    def step_run_update_rerun_with_http_info(tenant, step_run, rerun_step_run_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling StepRunApi.step_run_update_rerun, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && step_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_run" when calling StepRunApi.step_run_update_rerun, the character length must be great than or equal to 36.'
      end
    ...
    def workflow_run_list_step_run_events_with_http_info(tenant, workflow_run, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling StepRunApi.workflow_run_list_step_run_events, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && workflow_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "workflow_run" when calling StepRunApi.workflow_run_list_step_run_events, the character length must be great than or equal to 36.'
      end
