...
module HatchetSdkRest
  class WorkerApi
    ...
    def worker_get_with_http_info(worker, opts = {})
      ...
      if @api_client.config.client_side_validation && worker.to_s.length < 36
        fail ArgumentError, 'invalid value for "worker" when calling WorkerApi.worker_get, the character length must be great than or equal to 36.'
      end
    ...
    def worker_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkerApi.worker_list, the character length must be great than or equal to 36.'
      end
    ...
    def worker_update_with_http_info(worker, update_worker_request, opts = {})
      ...
      if @api_client.config.client_side_validation && worker.to_s.length < 36
        fail ArgumentError, 'invalid value for "worker" when calling WorkerApi.worker_update, the character length must be great than or equal to 36.'
      end
