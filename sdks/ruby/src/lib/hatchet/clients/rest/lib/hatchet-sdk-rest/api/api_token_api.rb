...
module HatchetSdkRest
  class APITokenApi
    ...
    def api_token_create_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling APITokenApi.api_token_create, the character length must be great than or equal to 36.'
      end
    ...
    def api_token_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling APITokenApi.api_token_list, the character length must be great than or equal to 36.'
      end
    ...
    def api_token_update_revoke_with_http_info(api_token, opts = {})
      ...
      if @api_client.config.client_side_validation && api_token.to_s.length < 36
        fail ArgumentError, 'invalid value for "api_token" when calling APITokenApi.api_token_update_revoke, the character length must be great than or equal to 36.'
      end
