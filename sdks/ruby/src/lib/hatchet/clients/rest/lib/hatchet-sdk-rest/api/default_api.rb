...
module HatchetSdkRest
  class DefaultApi
    ...
    def monitoring_post_run_probe_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling DefaultApi.monitoring_post_run_probe, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_invite_delete_with_http_info(tenant, tenant_invite, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling DefaultApi.tenant_invite_delete, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && tenant_invite.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant_invite" when calling DefaultApi.tenant_invite_delete, the character length must be great than or equal to 36.'
      end
    ...
    def tenant_invite_update_with_http_info(tenant, tenant_invite, update_tenant_invite_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling DefaultApi.tenant_invite_update, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && tenant_invite.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant_invite" when calling DefaultApi.tenant_invite_update, the character length must be great than or equal to 36.'
      end
    ...
    def webhook_create_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling DefaultApi.webhook_create, the character length must be great than or equal to 36.'
      end
    ...
    def webhook_delete_with_http_info(webhook, opts = {})
      ...
      if @api_client.config.client_side_validation && webhook.to_s.length < 36
        fail ArgumentError, 'invalid value for "webhook" when calling DefaultApi.webhook_delete, the character length must be great than or equal to 36.'
      end
    ...
    def webhook_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling DefaultApi.webhook_list, the character length must be great than or equal to 36.'
      end
    ...
    def webhook_requests_list_with_http_info(webhook, opts = {})
      ...
      if @api_client.config.client_side_validation && webhook.to_s.length < 36
        fail ArgumentError, 'invalid value for "webhook" when calling DefaultApi.webhook_requests_list, the character length must be great than or equal to 36.'
      end
