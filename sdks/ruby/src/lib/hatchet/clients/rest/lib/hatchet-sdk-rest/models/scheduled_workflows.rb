...
module HatchetSdkRest
  class ScheduledWorkflows
    ...
    def list_invalid_properties
      ...
      if !@workflow_run_id.nil? && @workflow_run_id.to_s.length < 36
        invalid_properties.push('invalid value for "workflow_run_id", the character length must be great than or equal to 36.')
      end
    ...
    def workflow_run_id=(workflow_run_id)
      ...
      if workflow_run_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "workflow_run_id", the character length must be great than or equal to 36.'
      end
