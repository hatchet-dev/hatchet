...
module HatchetSdkRest
  class V1CELDebugRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HatchetSdkRest::V1CELDebugRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HatchetSdkRest::V1CELDebugRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'filter_payload')
        self.filter_payload = attributes[:'filter_payload']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          input == o.input &&
          filter_payload == o.filter_payload &&
    ...
    def hash
      [expression, input, filter_payload, additional_metadata].hash
    end
