...
module HatchetSdkRest
  class JobRun < ApiModelBase
    ...
    def hash
      [metadata, tenant_id, workflow_run_id, job_id, status, workflow_run, job, ticker_id, step_runs, result, started_at, finished_at, timeout_at, cancelled_at, cancelled_reason, cancelled_error].hash
    end
