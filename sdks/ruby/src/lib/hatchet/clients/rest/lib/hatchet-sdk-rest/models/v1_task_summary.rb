...
module HatchetSdkRest
  class V1TaskSummary
    ...
    def list_invalid_properties
      ...
      if !@step_id.nil? && @step_id.to_s.length < 36
        invalid_properties.push('invalid value for "step_id", the character length must be great than or equal to 36.')
      end
    ...
    def step_id=(step_id)
      ...
      if step_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "step_id", the character length must be great than or equal to 36.'
      end
