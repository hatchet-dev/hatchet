...
module HatchetSdkRest
  class WorkflowRunApi
    ...
    def cron_workflow_trigger_create_with_http_info(tenant, workflow, create_cron_workflow_trigger_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunApi.cron_workflow_trigger_create, the character length must be great than or equal to 36.'
      end
    ...
    def scheduled_workflow_run_create_with_http_info(tenant, workflow, schedule_workflow_run_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunApi.scheduled_workflow_run_create, the character length must be great than or equal to 36.'
      end
    ...
    def workflow_run_cancel_with_http_info(tenant, workflow_runs_cancel_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunApi.workflow_run_cancel, the character length must be great than or equal to 36.'
      end
    ...
    def workflow_run_create_with_http_info(workflow, trigger_workflow_run_request, opts = {})
      ...
      if @api_client.config.client_side_validation && workflow.to_s.length < 36
        fail ArgumentError, 'invalid value for "workflow" when calling WorkflowRunApi.workflow_run_create, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'version'].nil? && opts[:'version'].to_s.length < 36
        fail ArgumentError, 'invalid value for "opts[:"version"]" when calling WorkflowRunApi.workflow_run_create, the character length must be great than or equal to 36.'
      end
    ...
    def workflow_run_get_input_with_http_info(tenant, workflow_run, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunApi.workflow_run_get_input, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && workflow_run.to_s.length < 36
        fail ArgumentError, 'invalid value for "workflow_run" when calling WorkflowRunApi.workflow_run_get_input, the character length must be great than or equal to 36.'
      end
    ...
    def workflow_run_update_replay_with_http_info(tenant, replay_workflow_runs_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WorkflowRunApi.workflow_run_update_replay, the character length must be great than or equal to 36.'
      end
