...
module HatchetSdkRest
  class EventApi
    ...
    def event_create_with_http_info(tenant, create_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_create, the character length must be great than or equal to 36.'
      end
    ...
    def event_create_bulk_with_http_info(tenant, bulk_create_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_create_bulk, the character length must be great than or equal to 36.'
      end
    ...
    def event_data_get_with_http_info(event, opts = {})
      ...
      if @api_client.config.client_side_validation && event.to_s.length < 36
        fail ArgumentError, 'invalid value for "event" when calling EventApi.event_data_get, the character length must be great than or equal to 36.'
      end
    ...
    def event_data_get_with_tenant_with_http_info(event_with_tenant, tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && event_with_tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "event_with_tenant" when calling EventApi.event_data_get_with_tenant, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_data_get_with_tenant, the character length must be great than or equal to 36.'
      end
    ...
    def event_get_with_http_info(event, opts = {})
      ...
      if @api_client.config.client_side_validation && event.to_s.length < 36
        fail ArgumentError, 'invalid value for "event" when calling EventApi.event_get, the character length must be great than or equal to 36.'
      end
    ...
    def event_key_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_key_list, the character length must be great than or equal to 36.'
      end
    ...
    def event_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_list, the character length must be great than or equal to 36.'
      end
    ...
    def event_update_cancel_with_http_info(tenant, cancel_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_update_cancel, the character length must be great than or equal to 36.'
      end
    ...
    def event_update_replay_with_http_info(tenant, replay_event_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.event_update_replay, the character length must be great than or equal to 36.'
      end
    ...
    def v1_event_get_with_http_info(tenant, v1_event, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.v1_event_get, the character length must be great than or equal to 36.'
      end
      ...
      if @api_client.config.client_side_validation && v1_event.to_s.length < 36
        fail ArgumentError, 'invalid value for "v1_event" when calling EventApi.v1_event_get, the character length must be great than or equal to 36.'
      end
    ...
    def v1_event_key_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.v1_event_key_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_event_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling EventApi.v1_event_list, the character length must be great than or equal to 36.'
      end
