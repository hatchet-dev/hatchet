...
module HatchetSdkRest
  class V1TaskTiming
    ...
    def list_invalid_properties
      ...
      if !@parent_task_external_id.nil? && @parent_task_external_id.to_s.length < 36
        invalid_properties.push('invalid value for "parent_task_external_id", the character length must be great than or equal to 36.')
      end
    ...
    def parent_task_external_id=(parent_task_external_id)
      ...
      if parent_task_external_id.to_s.length < 36
        fail ArgumentError, 'invalid value for "parent_task_external_id", the character length must be great than or equal to 36.'
      end
