...
module HatchetSdkRest
  class SNSApi
    ...
    def sns_create_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling SNSApi.sns_create, the character length must be great than or equal to 36.'
      end
    ...
    def sns_delete_with_http_info(sns, opts = {})
      ...
      if @api_client.config.client_side_validation && sns.to_s.length < 36
        fail ArgumentError, 'invalid value for "sns" when calling SNSApi.sns_delete, the character length must be great than or equal to 36.'
      end
    ...
    def sns_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling SNSApi.sns_list, the character length must be great than or equal to 36.'
      end
