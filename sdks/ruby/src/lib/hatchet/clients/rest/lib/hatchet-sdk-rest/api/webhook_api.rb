...
module HatchetSdkRest
  class WebhookApi
    ...
    def v1_webhook_create_with_http_info(tenant, v1_create_webhook_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WebhookApi.v1_webhook_create, the character length must be great than or equal to 36.'
      end
    ...
    def v1_webhook_delete_with_http_info(tenant, v1_webhook, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WebhookApi.v1_webhook_delete, the character length must be great than or equal to 36.'
      end
    ...
    def v1_webhook_get_with_http_info(tenant, v1_webhook, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WebhookApi.v1_webhook_get, the character length must be great than or equal to 36.'
      end
    ...
    def v1_webhook_list_with_http_info(tenant, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WebhookApi.v1_webhook_list, the character length must be great than or equal to 36.'
      end
    ...
    def v1_webhook_receive_with_http_info(tenant, v1_webhook, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WebhookApi.v1_webhook_receive, the character length must be great than or equal to 36.'
      end
    ...
    def v1_webhook_update_with_http_info(tenant, v1_webhook, v1_update_webhook_request, opts = {})
      ...
      if @api_client.config.client_side_validation && tenant.to_s.length < 36
        fail ArgumentError, 'invalid value for "tenant" when calling WebhookApi.v1_webhook_update, the character length must be great than or equal to 36.'
      end
