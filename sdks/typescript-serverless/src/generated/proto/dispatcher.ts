...
export const WorkerRegisterRequest: MessageFns<WorkerRegisterRequest> = {
  ...
  fromPartial(object: DeepPartial<WorkerRegisterRequest>): WorkerRegisterRequest {
    ...
    message.labels = (globalThis.Object.entries(object.labels ?? {}) as [string, WorkerLabels][]).reduce(
      (acc: { [key: string]: WorkerLabels }, [key, value]: [string, WorkerLabels]) => {
        if (value !== undefined) {
    ...
    message.runtimeInfo = (object.runtimeInfo !== undefined && object.runtimeInfo !== null)
      ...
      : undefined;
    message.slotConfig = (globalThis.Object.entries(object.slotConfig ?? {}) as [string, number][]).reduce(
...
export const AssignedAction: MessageFns<AssignedAction> = {
  encode(message: AssignedAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.batchStartPayload !== undefined) {
      BatchStartPayload.encode(message.batchStartPayload, writer.uint32(218).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 27: {
          ...
          message.batchStartPayload = BatchStartPayload.decode(reader, reader.uint32());
          continue;
        }
        case 28: {
          if (tag !== 226) {
  ...
  toJSON(message: AssignedAction): unknown {
    ...
    if (message.batchStartPayload !== undefined) {
      obj.batchStartPayload = BatchStartPayload.toJSON(message.batchStartPayload);
    }
    if (message.batchKey !== undefined) {
  ...
  fromPartial(object: DeepPartial<AssignedAction>): AssignedAction {
    ...
    message.batchStartPayload = (object.batchStartPayload !== undefined && object.batchStartPayload !== null)
...
export const BatchStartPayload: MessageFns<BatchStartPayload> = {
  encode(message: BatchStartPayload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.triggerTime !== undefined) {
      Timestamp.encode(toTimestamp(message.triggerTime), writer.uint32(18).fork()).join();
    }
...
function createBaseBatchActionEventItem(): BatchActionEventItem {
  return { taskRunExternalId: "", eventPayload: "", retryCount: undefined, shouldNotRetry: undefined };
}

export const BatchActionEventItem: MessageFns<BatchActionEventItem> = {
  encode(message: BatchActionEventItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.taskRunExternalId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchActionEventItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): BatchActionEventItem {
    return {
      taskRunExternalId: isSet(object.taskRunExternalId)
        ? globalThis.String(object.taskRunExternalId)
        : isSet(object.task_run_external_id)
  ...
  toJSON(message: BatchActionEventItem): unknown {
    const obj: any = {};
    if (message.taskRunExternalId !== "") {
      obj.taskRunExternalId = message.taskRunExternalId;
    }
  ...
  create(base?: DeepPartial<BatchActionEventItem>): BatchActionEventItem {
    return BatchActionEventItem.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchActionEventItem>): BatchActionEventItem {
    const message = createBaseBatchActionEventItem();
    message.taskRunExternalId = object.taskRunExternalId ?? "";
    message.eventPayload = object.eventPayload ?? "";
    message.retryCount = object.retryCount ?? undefined;
...
function createBaseBatchActionEvent(): BatchActionEvent {
  return {
    workerId: "",
    jobId: "",
    actionId: "",
...
export const BatchActionEvent: MessageFns<BatchActionEvent> = {
  encode(message: BatchActionEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.workerId !== "") {
      writer.uint32(10).string(message.workerId);
    }
    if (message.jobId !== "") {
    ...
    for (const v of message.items) {
      BatchActionEventItem.encode(v!, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BatchActionEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.items.push(BatchActionEventItem.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): BatchActionEvent {
    return {
      workerId: isSet(object.workerId)
        ? globalThis.String(object.workerId)
        : isSet(object.worker_id)
      ...
      items: globalThis.Array.isArray(object?.items)
        ? object.items.map((e: any) => BatchActionEventItem.fromJSON(e))
        : [],
    };
  },

  toJSON(message: BatchActionEvent): unknown {
    const obj: any = {};
    if (message.workerId !== "") {
      obj.workerId = message.workerId;
    }
    ...
    if (message.items?.length) {
      obj.items = message.items.map((e) => BatchActionEventItem.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<BatchActionEvent>): BatchActionEvent {
    return BatchActionEvent.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchActionEvent>): BatchActionEvent {
    const message = createBaseBatchActionEvent();
    message.workerId = object.workerId ?? "";
    message.jobId = object.jobId ?? "";
    message.actionId = object.actionId ?? "";
    ...
    message.eventTimestamp = object.eventTimestamp ?? undefined;
    message.eventType = object.eventType ?? 0;
    message.items = object.items?.map((e) => BatchActionEventItem.fromPartial(e)) || [];
    return message;
  },
};
...
export const DispatcherDefinition = {
  ...
  methods: {
    register: {
      name: "Register",
      requestType: WorkerRegisterRequest as typeof WorkerRegisterRequest,
      requestStream: false,
      responseType: WorkerRegisterResponse as typeof WorkerRegisterResponse,
      responseStream: false,
      options: {},
    },
    listen: {
      name: "Listen",
      requestType: WorkerListenRequest as typeof WorkerListenRequest,
      requestStream: false,
      responseType: AssignedAction as typeof AssignedAction,
      responseStream: true,
      options: {},
    },
    /**
    ...
    heartbeat: {
      name: "Heartbeat",
      requestType: HeartbeatRequest as typeof HeartbeatRequest,
      requestStream: false,
      responseType: HeartbeatResponse as typeof HeartbeatResponse,
      responseStream: false,
      options: {},
    },
    subscribeToWorkflowEvents: {
      name: "SubscribeToWorkflowEvents",
      requestType: SubscribeToWorkflowEventsRequest as typeof SubscribeToWorkflowEventsRequest,
      requestStream: false,
    ...
    subscribeToWorkflowRuns: {
      ...
      requestType: SubscribeToWorkflowRunsRequest as typeof SubscribeToWorkflowRunsRequest,
      requestStream: true,
      responseType: WorkflowRunEvent as typeof WorkflowRunEvent,
      responseStream: true,
      options: {},
    },
    sendStepActionEvent: {
      name: "SendStepActionEvent",
      requestType: StepActionEvent as typeof StepActionEvent,
      requestStream: false,
      responseType: ActionEventResponse as typeof ActionEventResponse,
      responseStream: false,
      options: {},
    },
    /**
    ...
    sendBatchActionEvent: {
      ...
      requestType: BatchActionEvent as typeof BatchActionEvent,
      requestStream: false,
      responseType: ActionEventResponse as typeof ActionEventResponse,
      responseStream: false,
      options: {},
    ...
    sendGroupKeyActionEvent: {
      ...
      requestType: GroupKeyActionEvent as typeof GroupKeyActionEvent,
      requestStream: false,
      responseType: ActionEventResponse as typeof ActionEventResponse,
      responseStream: false,
      options: {},
    ...
    putOverridesData: {
      ...
      requestType: OverridesData as typeof OverridesData,
      requestStream: false,
      responseType: OverridesDataResponse as typeof OverridesDataResponse,
      responseStream: false,
      options: {},
    },
    unsubscribe: {
      name: "Unsubscribe",
      requestType: WorkerUnsubscribeRequest as typeof WorkerUnsubscribeRequest,
      requestStream: false,
      responseType: WorkerUnsubscribeResponse as typeof WorkerUnsubscribeResponse,
      responseStream: false,
      options: {},
    },
    refreshTimeout: {
      name: "RefreshTimeout",
      requestType: RefreshTimeoutRequest as typeof RefreshTimeoutRequest,
      requestStream: false,
      responseType: RefreshTimeoutResponse as typeof RefreshTimeoutResponse,
      responseStream: false,
      options: {},
    },
    releaseSlot: {
      name: "ReleaseSlot",
      requestType: ReleaseSlotRequest as typeof ReleaseSlotRequest,
      requestStream: false,
      responseType: ReleaseSlotResponse as typeof ReleaseSlotResponse,
      responseStream: false,
      options: {},
    },
    restoreEvictedTask: {
      name: "RestoreEvictedTask",
      requestType: RestoreEvictedTaskRequest as typeof RestoreEvictedTaskRequest,
      requestStream: false,
      responseType: RestoreEvictedTaskResponse as typeof RestoreEvictedTaskResponse,
      responseStream: false,
      options: {},
    },
    upsertWorkerLabels: {
      name: "UpsertWorkerLabels",
      requestType: UpsertWorkerLabelsRequest as typeof UpsertWorkerLabelsRequest,
      requestStream: false,
      responseType: UpsertWorkerLabelsResponse as typeof UpsertWorkerLabelsResponse,
      responseStream: false,
      options: {},
    },
    /**
    ...
    getVersion: {
      name: "GetVersion",
      requestType: GetVersionRequest as typeof GetVersionRequest,
      requestStream: false,
      responseType: GetVersionResponse as typeof GetVersionResponse,
      responseStream: false,
      options: {},
    },
  },
...
export interface DispatcherClient<CallOptionsExt = {}> {
   ...
   */
  sendBatchActionEvent(
    request: DeepPartial<BatchActionEvent>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ActionEventResponse>;
  sendGroupKeyActionEvent(
