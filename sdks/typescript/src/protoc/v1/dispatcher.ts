...
export interface DurableTaskEventRequest {
  ...
  triggerOpts?: TriggerWorkflowRequest | undefined;
...
export const DurableTaskEventRequest: MessageFns<DurableTaskEventRequest> = {
  encode(
    ...
    if (message.triggerOpts !== undefined) {
      TriggerWorkflowRequest.encode(message.triggerOpts, writer.uint32(50).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.triggerOpts = TriggerWorkflowRequest.decode(reader, reader.uint32());
          continue;
        }
        case 7: {
          if (tag !== 58) {
  ...
  fromJSON(object: any): DurableTaskEventRequest {
    return {
      ...
      waitForConditions: isSet(object.waitForConditions)
        ...
        : undefined,
      triggerOpts: isSet(object.triggerOpts)
        ? TriggerWorkflowRequest.fromJSON(object.triggerOpts)
        : undefined,
  ...
  toJSON(message: DurableTaskEventRequest): unknown {
    ...
    if (message.triggerOpts !== undefined) {
      obj.triggerOpts = TriggerWorkflowRequest.toJSON(message.triggerOpts);
    }
    if (message.memoKey !== undefined) {
  ...
  fromPartial(object: DeepPartial<DurableTaskEventRequest>): DurableTaskEventRequest {
    ...
    message.waitForConditions =
      object.waitForConditions !== undefined && object.waitForConditions !== null
        ...
        : undefined;
    message.triggerOpts =
      object.triggerOpts !== undefined && object.triggerOpts !== null
        ? TriggerWorkflowRequest.fromPartial(object.triggerOpts)
        : undefined;
