...
export const AssignedAction: MessageFns<AssignedAction> = {
  encode(message: AssignedAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.batchStart !== undefined) {
      BatchStartPayload.encode(message.batchStart, writer.uint32(218).fork()).join();
    }
  ...
  fromJSON(object: any): AssignedAction {
    return {
      ...
      batchStart: isSet(object.batchStart) ? BatchStartPayload.fromJSON(object.batchStart) : undefined,
  ...
  fromPartial(object: DeepPartial<AssignedAction>): AssignedAction {
    ...
    message.batchStart = (object.batchStart !== undefined && object.batchStart !== null)
