...
protoc --proto_path=api-contracts/events --go_out=./internal/services/ingestor/contracts --go_opt=paths=source_relative \
    ...
    --connect-go_out=./internal/services/ingestor/contracts --connect-go_opt=paths=source_relative,simple=true \
    events.proto
...
protoc --proto_path=api-contracts/workflows --proto_path=api-contracts \
    ...
    --connect-go_out=./internal/services/admin/contracts --connect-go_opt=paths=source_relative,simple=true \
    workflows.proto
