...
async def exception_class_no_name_task(input: None, ctx: Context) -> None:
...
@exception_parsing_workflow.task()
async def exception_class_task(input: None, ctx: Context) -> None:
    raise ValueError


@exception_parsing_workflow.task()
async def exception_instance_no_args_task(input: None, ctx: Context) -> None:
    raise ValueError()


@exception_parsing_workflow.task()
async def exception_instance_falsy_arg_task(input: None, ctx: Context) -> None:
    raise ValueError("")


@exception_parsing_workflow.task()
async def exception_instance_truthy_arg_task(input: None, ctx: Context) -> None:
