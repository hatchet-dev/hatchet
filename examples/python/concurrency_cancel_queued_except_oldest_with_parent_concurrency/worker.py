...
concurrency_cancel_queued_except_oldest_with_parent_concurrency_workflow = hatchet.workflow(
...
def main() -> None:
    worker = hatchet.worker(
        ...
        workflows=[concurrency_cancel_queued_except_oldest_with_parent_concurrency_workflow],
    )
    worker.start()
