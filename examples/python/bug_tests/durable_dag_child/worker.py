...
@hatchet.task()
async def spawned_child(input: None, ctx: Context) -> None:
    pass
...
async def child_dag_step_a(input: None, ctx: Context) -> None:
    pass


@spawned_child_dag.task(parents=[child_dag_step_a])
async def child_dag_step_b(input: None, ctx: Context) -> SpawnedRuns:
    ref = await spawned_child.aio_run(wait_for_result=False)
...
@parent_dag.task()
async def step_a(input: None, ctx: Context) -> SpawnedRuns:
    ref = await spawned_child.aio_run(wait_for_result=False)
...
async def step_b(input: None, ctx: Context) -> None:
    pass
...
async def spawn_dag_step_a(input: None, ctx: Context) -> SpawnedRuns:
    ref = await spawned_child_dag.aio_run(wait_for_result=False)

    return SpawnedRuns(spawned_run_ids=[ref.workflow_run_id])


@dag_spawning_dag.task(parents=[spawn_dag_step_a])
async def spawn_dag_step_b(input: None, ctx: Context) -> None:
    pass
...
@diamond_dag.task()
async def diamond_root(input: None, ctx: Context) -> SpawnedRuns:
    # claim every step index in the DAG, not just the next unused spawn index
    refs = [
        await spawned_child.aio_run(wait_for_result=False)
        for _ in range(DIAMOND_STEP_COUNT)
    ]
...
async def diamond_left(input: None, ctx: Context) -> None:
    pass


@diamond_dag.task(parents=[diamond_root])
async def diamond_right(input: None, ctx: Context) -> None:
    pass


@diamond_dag.task(parents=[diamond_left, diamond_right])
async def diamond_join(input: None, ctx: Context) -> None:
    pass
...
async def multi_spawner_first(input: None, ctx: Context) -> SpawnedRuns:
    ref = await spawned_child.aio_run(wait_for_result=False)
...
async def multi_spawner_second(input: None, ctx: Context) -> SpawnedRuns:
    ref = await spawned_child.aio_run(wait_for_result=False)
...
async def multi_spawner_third(input: None, ctx: Context) -> None:
    pass
...
async def durable_spawner_first(input: None, ctx: DurableContext) -> SpawnedRuns:
...
async def durable_spawner_second(input: None, ctx: Context) -> None:
    pass
...
async def mixed_durable_step(input: None, ctx: DurableContext) -> SpawnedRuns:
    ref = await spawned_child.aio_run(wait_for_result=False)
...
async def mixed_regular_step(input: None, ctx: Context) -> SpawnedRuns:
    ref = await spawned_child.aio_run(wait_for_result=False)
...
async def mixed_final_step(input: None, ctx: Context) -> None:
    pass
