...
STEP1_CIP = CONCURRENCY_CANCEL_IN_PROGRESS_WORKFLOW.task(:step1) do |_input, _ctx|
  50.times { sleep 0.10 }
end

CONCURRENCY_CANCEL_IN_PROGRESS_WORKFLOW.task(:step2, parents: [STEP1_CIP]) do |_input, _ctx|
  50.times { sleep 0.10 }
end
