...
func main() {
	...
	workflow.NewDurableTask("long-running-task", func(ctx hatchet.DurableContext, input DurableInput) (DurableOutput, error) {
	...
	err = client.Run(context.Background(), "durable-workflow", DurableInput{
