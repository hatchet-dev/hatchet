...
class WorkflowDeploymentConfig(BaseModel):
    ...
    github_app_installation: Optional[GithubAppInstallation] = Field(default=None, description="The Github App installation.", alias="githubAppInstallation")
    github_app_installation_id: StrictStr = Field(description="The id of the Github App installation.", alias="githubAppInstallationId")
    __properties: ClassVar[List[str]] = ["metadata", "gitRepoName", "gitRepoOwner", "gitRepoBranch", "githubAppInstallation", "githubAppInstallationId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "githubAppInstallation": GithubAppInstallation.from_dict(obj["githubAppInstallation"]) if obj.get("githubAppInstallation") is not None else None,
