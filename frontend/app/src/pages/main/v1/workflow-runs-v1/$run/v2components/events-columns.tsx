      ...
      cell: ({ row }) => {
        return (
          <div className="min-w-[120px] max-w-[180px]">
            ...
            >
              <ArrowLeftEndOnRectangleIcon className="mr-1 h-4 w-4" />
          ...
          items.push(
            ...
            >
              <Button
                variant="link"
                size="xs"
                className="font-mono text-xs tracking-tight text-muted-foreground brightness-150"
              >
                <ServerStackIcon className="mr-1 h-4 w-4" />
                View Worker
              </Button>
            </Link>,
          );
