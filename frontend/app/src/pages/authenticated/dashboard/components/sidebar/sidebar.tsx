...
import { UserBlock } from './user-dropdown';
      ...
      <Sidebar variant="inset" collapsible="icon">
        ...
        <SidebarContent>
          ...
          <SidebarGroup className="group-data-[collapsible=icon]:hidden">
            ...
            <SidebarMenu>
              {mainNavLinks.projects.map((item) => (
          ...
          <SidebarGroup className="mt-auto">
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                {mainNavLinks.navSecondary.map((item) => (
