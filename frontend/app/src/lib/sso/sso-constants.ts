...
export const PROVIDER_CONFIG = {
    Okta: {
        displayName: "Okta",
        defaultForm: { provider: "Okta", clientId: "", clientSecret: "", ssoDomain: "", usesPkce: true },
        docsUrl: "https://docs.byo.propelauth.com/sso/example-setup-guides/okta",
    },
    MicrosoftEntra: {
        displayName: "Microsoft Entra",
        defaultForm: { provider: "MicrosoftEntra", clientId: "", clientSecret: "", tenantId: "", usesPkce: true },
    ...
    OneLogin: {
        ...
        docsUrl: "https://docs.byo.propelauth.com/sso/example-setup-guides/onelogin",
    },
    JumpCloud: {
        ...
        docsUrl: "https://docs.byo.propelauth.com/sso/example-setup-guides/jumpcloud",
    },
    Generic: {
        displayName: "Generic",
        defaultForm: {
        ...
        docsUrl: "https://docs.byo.propelauth.com/sso/example-setup-guides/overview",
    },
} as const;
