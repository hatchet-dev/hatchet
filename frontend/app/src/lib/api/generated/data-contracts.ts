...
export interface V1DurableEventLogEntry {
  ...
  waitConditionKind?: V1DurableWaitConditionKind;
   ...
   */
  insertedAt: string;
  /** A user-provided message or label, send when establishing a durable wait */
  userMessage?: string;
  /** A human-readable message, generated by the engine, describing the current status of a durable task */
