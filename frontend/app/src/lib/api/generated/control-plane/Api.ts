...
> extends HttpClient<SecurityDataType> {
   ...
   * @request DELETE:/api/v1/control-plane/organization-tenants/{organization-tenant}
   * @secure
   */
  organizationTenantDelete = (
    ...
    this.request<OrganizationTenant, APIError>({
      path: `/api/v1/control-plane/organization-tenants/${organizationTenant}`,
      method: "DELETE",
      secure: true,
      format: "json",
      ...params,
   ...
   * @request POST:/api/v1/control-plane/tenants/{organization-tenant}/token
   * @secure
   */
  exchangeTokenCreate = (
    organizationTenant: string,
    ...
    this.request<TenantToken, APIError>({
      path: `/api/v1/control-plane/tenants/${organizationTenant}/token`,
      method: "POST",
      secure: true,
      format: "json",
      ...params,
