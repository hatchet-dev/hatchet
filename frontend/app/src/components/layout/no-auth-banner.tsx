...
export function NoAuthBanner() {
  return (
    ...
    >
      ...
      Heads up: local no-auth mode is on, so there's no sign-in and every request acts as the
      default admin. Great for local development, but please don't use it in production.
    </div>
  );
}
