...
| **Trigger**    | How a workflow starts: [direct run](/features/run-with-results), [event](/features/run-on-event), [cron](/features/cron-runs), [schedule](/features/scheduled-runs), or [webhooks](/features/webhooks) |
...
<Cards>
  <Cards.Card title="Durable Task Execution" href="/guide/durable-workflows/durable-task-execution">
