...
<Callout type="info">
  ...
  Pipelines](/guide/patterns/pre-determined-pipelines). The stages (ingest,
  chunk, embed, index) are fixed and map directly to a DAG. Use
  [Fanout](/guide/patterns/fanout) within the chunking stage to parallelize.
</Callout>
...
<Cards>
  ...
  <Cards.Card title="Batch Processing" href="/guide/use-cases/batch-processing">
