...
<Callout type="info">
  Cycles use [Procedural Child Spawning](/features/child-spawning) under the hood;
...
<Cards>
  <Cards.Card title="AI Agent Loops" href="/features/child-spawning">
    Build agents that reason, take action, observe results, and loop until they
    achieve their goal.
  </Cards.Card>
  <Cards.Card title="Polling External APIs" href="/features/child-spawning">
    Check an external service repeatedly until a resource is ready or a status
    changes.
  </Cards.Card>
  <Cards.Card title="Iterative Data Processing" href="/features/child-spawning">
    Process data in successive passes, refining results until convergence.
  </Cards.Card>
  <Cards.Card title="Custom Retry Logic" href="/features/retry-policies">
...
- [Procedural Child Spawning](/features/child-spawning): the mechanism that powers cycle iteration
- [Retry Policies](/features/retry-policies): built-in retry support for simpler retry scenarios
- [Branching](/guide/patterns/branching): combine cycles with conditional logic
- [Fanout](/guide/patterns/fanout): spawn parallel tasks instead of sequential iterations
