...
- [Fanout](/guide/patterns/fanout): dynamically spawn tasks instead of choosing between fixed branches
- [Pre-Determined Pipelines](/guide/patterns/pre-determined-pipelines): fixed-structure pipelines without branching
