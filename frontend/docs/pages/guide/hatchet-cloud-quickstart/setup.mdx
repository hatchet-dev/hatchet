...
<Callout type="info">
  ...
  [Hatchet Cloud Quickstart](/guide/hatchet-cloud-quickstart) or the [Self-Hosting
...
Continue to the next section to learn how to [create your first task](/guide/your-first-task)
