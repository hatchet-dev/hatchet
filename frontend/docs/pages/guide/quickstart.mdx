...
See the [full setup guide](/guide/install-docs-mcp) for manual configuration options.
...
Once you've completed the quickstart, you can explore a more in-depth walkthrough of Hatchet using the [Advanced Setup](/guide/hatchet-cloud-quickstart/advanced) guide.
