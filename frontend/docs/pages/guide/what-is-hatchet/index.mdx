...
You write simple functions, called [tasks](/guide/your-first-task), in Python, Typescript, and Go and run them on [workers](/guide/workers) in your own infrastructure. You can compose these tasks into [parent/child relationships](/concepts/child-spawning) or predefined as [Directed Acyclic Graphs (DAGs)](/concepts/dags) to build more complex pipelines, which we call [workflows](/concepts/orchestration). All tasks and workflows are **defined as code**, making them easy to version, test, and deploy.
