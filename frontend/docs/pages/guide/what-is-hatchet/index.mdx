...
- **AI agents**: a core number of Hatchet's features, like [webhooks](/guide/webhooks), [child spawning](/features/child-spawning), and [dynamic workflows](/features/child-spawning) are designed to support AI agents.
- **Event-driven systems**: Hatchet's [eventing features](/guide/run-on-event) allow you to build event-driven architectures without requiring additional infrastructure.
