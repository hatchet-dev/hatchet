...
**Predictable execution order.** The default task assignment strategy is First In First Out (FIFO) which can be modified with [concurrency policies](/features/concurrency), [rate limits](/features/rate-limits), and [priorities](/features/priority).
...
**[Quick Start](/guide/hatchet-cloud-quickstart/setup)** - Set up your first Hatchet worker.
