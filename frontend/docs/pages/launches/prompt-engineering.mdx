...
Navigate to the Hatchet dashboard and select the **Workflows** tab. You should see a workflow called `SimpleGenAiWorkflow`. Click on it to see the inputs and outputs of each step in the workflow.
