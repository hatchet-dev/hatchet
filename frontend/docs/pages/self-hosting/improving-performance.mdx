...
export const BulkFanoutWorker = {
  path: "examples/bulk_fanout/worker.py",
};

export const getStaticProps = ({}) => getSnippets([BulkFanoutWorker]);
...
<GithubSnippet src={BulkFanoutWorker} target="BulkFanoutParent" />
