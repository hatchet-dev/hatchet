...
| Metric Name                              | Type      | Description                                                                          |
| ---------------------------------------- | --------- | ------------------------------------------------------------------------------------ |
| `tenant_workflow_duration_milliseconds`  | Histogram | Duration of workflow execution in milliseconds (DAGs and single tasks)               |
| `tenant_assigned_tasks`                  | Counter   | The total number of tasks assigned to a worker                                       |
| `tenant_scheduling_timed_out`            | Counter   | The total number of tasks that timed out while waiting to be scheduled               |
| `tenant_rate_limited`                    | Counter   | The total number of tasks that were rate limited                                     |
| `tenant_queued_to_assigned`              | Counter   | The total number of unique tasks that were queued and later got assigned to a worker |
| `tenant_queued_to_assigned_time_seconds` | Histogram | Buckets of time in seconds spent in the queue before being assigned to a worker      |
