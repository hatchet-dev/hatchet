  ...
  {[
    {
      ...
      href: "/changelog/reference/platform",
      lang: "go",
    },
    { label: "Python SDK", href: "/changelog/reference/python", lang: "py" },
    {
      label: "TypeScript SDK",
      href: "/changelog/reference/typescript",
      lang: "ts",
    },
    { label: "Ruby SDK", href: "/changelog/reference/ruby", lang: "rb" },
  ].map((item) => (
    <li
      key={item.href}
