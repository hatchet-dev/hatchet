...
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| `options` | [`CreateBatchTaskWorkflowOpts`](Runnables.mdx#createbatchtaskworkflowopts)\<`I` & `Resolved`\<`GlobalInput`, `MiddlewareBefore`\>, `MergeIfNonEmpty`\<`O`, `GlobalOutput`\>\> | Batch task configuration options |
...
| Parameter | Type                                                                                                                             | Description                                                       |
| --------- | -------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| `options` | `object` & `Omit`\<[`CreateBatchTaskWorkflowOpts`](Runnables.mdx#createbatchtaskworkflowopts)\<`I`, `O`\>, `"batch"` \| `"fn"`\> | Batch task configuration options with function that defines types |
