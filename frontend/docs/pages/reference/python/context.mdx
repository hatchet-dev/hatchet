...
| Name                   | Description                                                                                                                                                              |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `was_skipped`          | Check if a given task was skipped. You can read about skipping in [the docs](/v1/durable-workflows/conditions#checking-if-a-task-was-skipped).                           |
...
Check if a given task was skipped. You can read about skipping in [the docs](/v1/durable-workflows/conditions#checking-if-a-task-was-skipped).
