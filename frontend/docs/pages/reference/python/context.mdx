...
| `label`       | `str \| None`                                     | Optional human-readable label shown in the dashboard run details. Use this to provide context about what the task is waiting for (e.g., "Waiting for payment confirmation"). | `None`     |
...
| `label`    | `str \| None`   | Optional human-readable label shown in the dashboard run details. Use this to provide context about what the task is waiting for. | `None`     |
...
| `scope`             | `str \| None`     | An optional scope to narrow down event matching. Required when using `lookback_window`.                                                                                             | `None`     |
| `lookback_window`   | `timedelta \| None` | An optional lookback window to check for events that arrived before the wait was established. Requires `scope` to be set.                                                        | `None`     |
| `label`             | `str \| None`     | Optional human-readable label shown in the dashboard run details. Use this to provide context about what the task is waiting for.                                                   | `None`     |
