...
| Name                   | Description                                                                                                                                                                         |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `was_skipped`          | Check if a given task was skipped. You can read about skipping in [the docs](/concepts/durable-workflows/directed-acyclic-graphs/parent-conditions#checking-if-a-task-was-skipped). |
...
Check if a given task was skipped. You can read about skipping in [the docs](/concepts/durable-workflows/directed-acyclic-graphs/parent-conditions#checking-if-a-task-was-skipped).
