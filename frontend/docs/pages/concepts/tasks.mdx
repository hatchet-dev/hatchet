...
<Callout type="info">
  ...
  guide](/get-started/your-first-task) to declare and run your first task.
</Callout>
...
When you define a task, you are telling Hatchet: "here is a piece of work that a worker can pick up." The task carries a name, the function to run, and optional configuration. Tasks are registered on [workers](/get-started/workers), which are the long-running processes that actually execute them.
