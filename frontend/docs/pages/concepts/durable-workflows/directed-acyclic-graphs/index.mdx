...
<Callout type="info">
  Just getting started? Check out the [essentials guide](/essentials/durable-workflows/directed-acyclic-graph) for an introduction to DAG workflows and how they fit into durable workflows.
</Callout>
