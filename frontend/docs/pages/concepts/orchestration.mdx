...
1. [Worker Slots](/concepts/understanding-slots) -- which is a way to control the number of tasks that can be executed concurrently on a given compute process.
