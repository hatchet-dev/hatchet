...
<Callout type="info">
  Just getting started? Check out the [essentials guide](/get-started/workers)
...
| [Preparing for Production](/get-started/production)   | Operational best practices for monitoring, error handling, and scaling. |
