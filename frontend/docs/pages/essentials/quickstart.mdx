...
<Callout type="info">
  This guide walks you through getting set up on Hatchet Cloud. If you'd like to self-host Hatchet, please see the [self-hosted quickstart](/self-hosting) instead.
</Callout>
...
Once you've completed the quickstart, you can explore a more in-depth walkthrough of Hatchet using the [Advanced Setup](/essentials/advanced) guide.
