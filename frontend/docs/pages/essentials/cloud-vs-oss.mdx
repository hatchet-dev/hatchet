...
- **[Quickstart](/essentials/quickstart)**: run a worker and trigger your first workflow
- **[Architecture & Guarantees](/essentials/architecture-and-guarantees)**: understand reliability semantics and tradeoffs
