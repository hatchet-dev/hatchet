...
<Callout type="info">
  Pre-determined pipelines are built using [DAG Workflows](/concepts/dags). See that
...
<Cards>
  <Cards.Card title="ETL Pipelines" href="/concepts/dags">
  ...
  <Cards.Card title="CI/CD Workflows" href="/concepts/dags">
    Build, test, and deploy in sequence with parallel test suites that fan back
    into a deploy step.
  </Cards.Card>
  <Cards.Card title="Document Processing" href="/concepts/dags">
    Parse, validate, enrich, and index documents through a fixed sequence of
    processing stages.
  </Cards.Card>
  <Cards.Card title="Multi-Step AI Pipelines" href="/concepts/dags">
...
- [DAG Workflows](/concepts/dags): full guide to defining workflows with task dependencies
...
- [Procedural Child Spawning](/concepts/child-spawning): combine pipelines with dynamic child tasks
