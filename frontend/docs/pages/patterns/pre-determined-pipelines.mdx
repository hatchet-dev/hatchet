...
<Callout type="info">
  Pre-determined pipelines are built using [DAG Workflows](/concepts/durable-workflows/directed-acyclic-graphs). See that
...
<Cards>
  <Cards.Card title="ETL Pipelines" href="/concepts/durable-workflows/directed-acyclic-graphs">
  ...
  <Cards.Card title="CI/CD Workflows" href="/concepts/durable-workflows/directed-acyclic-graphs">
    Build, test, and deploy in sequence with parallel test suites that fan back
    into a deploy step.
  </Cards.Card>
  <Cards.Card title="Document Processing" href="/concepts/durable-workflows/directed-acyclic-graphs">
    Parse, validate, enrich, and index documents through a fixed sequence of
    processing stages.
  </Cards.Card>
  <Cards.Card title="Multi-Step AI Pipelines" href="/concepts/durable-workflows/directed-acyclic-graphs">
