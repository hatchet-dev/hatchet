...
<Callout type="info">
  Pre-determined pipelines are built using [DAG Workflows](/features/dags). See that
...
<Cards>
  <Cards.Card title="ETL Pipelines" href="/features/dags">
  ...
  <Cards.Card title="CI/CD Workflows" href="/features/dags">
    Build, test, and deploy in sequence with parallel test suites that fan back
    into a deploy step.
  </Cards.Card>
  <Cards.Card title="Document Processing" href="/features/dags">
    Parse, validate, enrich, and index documents through a fixed sequence of
    processing stages.
  </Cards.Card>
  <Cards.Card title="Multi-Step AI Pipelines" href="/features/dags">
...
- [DAG Workflows](/features/dags): full guide to defining workflows with task dependencies
- [Fanout](/patterns/fanout): dynamically spawn tasks at runtime instead
- [Concurrency Control](/features/concurrency): limit concurrent task execution within a pipeline
- [Procedural Child Spawning](/features/child-spawning): combine pipelines with dynamic child tasks
