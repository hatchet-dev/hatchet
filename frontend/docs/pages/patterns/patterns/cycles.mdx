...
- [Branching](/patterns/patterns/branching): combine cycles with conditional logic
- [Fanout](/patterns/patterns/fanout): spawn parallel tasks instead of sequential iterations
