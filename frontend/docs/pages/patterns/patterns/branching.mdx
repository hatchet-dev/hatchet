...
<Callout type="info">
  Branching is built using [Conditional Workflows](/features/conditional-workflows).
...
<Cards>
  <Cards.Card title="Feature Flag Routing" href="/features/conditional-workflows">
    Read a feature flag in an upstream task and route the workflow down
    different code paths based on its value.
  </Cards.Card>
  <Cards.Card
    title="Human-in-the-Loop Approval"
    href="/features/conditional-workflows"
  >
    Pause workflow execution until a human approves or rejects, then branch
    accordingly.
  </Cards.Card>
  <Cards.Card title="A/B Testing Pipelines" href="/features/conditional-workflows">
...
- [Conditional Workflows](/features/conditional-workflows): full guide to conditions, or groups, and operators
- [DAG Workflows](/features/dags): define task dependencies that branching builds on
- [Fanout](/patterns/patterns/fanout): dynamically spawn tasks instead of choosing between fixed branches
- [Pre-Determined Pipelines](/patterns/patterns/pre-determined-pipelines): fixed-structure pipelines without branching
