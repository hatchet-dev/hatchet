...
<Callout type="info">
  Branching is built using [Conditional Workflows](/concepts/durable-workflows/directed-acyclic-graphs/conditional-workflows).
...
<Cards>
  <Cards.Card title="Feature Flag Routing" href="/concepts/durable-workflows/directed-acyclic-graphs/conditional-workflows">
    Read a feature flag in an upstream task and route the workflow down
    different code paths based on its value.
  </Cards.Card>
  <Cards.Card
    title="Human-in-the-Loop Approval"
    href="/concepts/durable-workflows/directed-acyclic-graphs/conditional-workflows"
  >
    Pause workflow execution until a human approves or rejects, then branch
    accordingly.
  </Cards.Card>
  <Cards.Card title="A/B Testing Pipelines" href="/concepts/durable-workflows/directed-acyclic-graphs/conditional-workflows">
...
- [Conditional Workflows](/concepts/durable-workflows/directed-acyclic-graphs/conditional-workflows): full guide to conditions, or groups, and operators
