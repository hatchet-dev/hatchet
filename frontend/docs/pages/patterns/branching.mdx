...
<Callout type="info">
  Branching is built using conditions on DAG tasks. See [Parent
  Conditions](/concepts/durable-workflows/directed-acyclic-graphs/parent-conditions),
  [Event
