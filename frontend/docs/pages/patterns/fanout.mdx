...
<Callout type="info">
  Fanout is built on top of [Procedural Child Spawning](/concepts/durable-workflows/directed-acyclic-graphs/child-spawning).
...
<Cards>
  ...
  <Cards.Card title="Map-Reduce Pipelines" href="/concepts/durable-workflows/directed-acyclic-graphs">
    Fan out to map tasks, then reduce results in a downstream DAG step.
  </Cards.Card>
  <Cards.Card title="Multi-Provider AI Inference" href="/concepts/durable-workflows/directed-acyclic-graphs/child-spawning">
