...
<Callout type="info">
  Fanout is built on top of [Procedural Child Spawning](/concepts/child-spawning).
...
<Callout type="warning">
  ...
  enough slots to handle the concurrent load. See [Worker Slots](/essentials/workers)
...
<Cards>
  ...
  <Cards.Card title="Map-Reduce Pipelines" href="/concepts/dags">
    Fan out to map tasks, then reduce results in a downstream DAG step.
  </Cards.Card>
  <Cards.Card title="Multi-Provider AI Inference" href="/concepts/child-spawning">
...
- [Procedural Child Spawning](/concepts/child-spawning): learn the full child task API
- [DAG Workflows](/concepts/dags): combine fanout with declarative task dependencies
