...
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| **[Durable Execution](/guide/durable-workflows/durable-task-execution)** | Checkpoints tool calls, LLM responses, and loop iterations so agent state survives crashes |
...
<Callout type="info">
  ...
  Execution](/guide/durable-workflows/durable-task-execution), completed iterations survive
...
- [Durable Workflows](/guide/durable-workflows/durable-task-execution): understand checkpointing and replay
