...
| ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| **[Durable Execution](/concepts/durable-workflows/durable-task-execution)**              | Checkpoints tool calls, LLM responses, and loop iterations so agent state survives crashes |
...
<Callout type="info">
  The agent loop pattern is a [Cycle](/patterns/cycles). Each iteration spawns a
  new child run via `RunChild`. Combined with [Durable
  Execution](/concepts/durable-workflows/durable-task-execution), completed
  iterations survive crashes and slots are freed between iterations.
</Callout>
