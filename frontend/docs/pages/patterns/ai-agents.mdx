...
| **[Durable Events](/concepts/durable-events)**            | Pause for human-in-the-loop feedback without holding worker slots                          |
| **[Durable Sleep](/concepts/durable-sleep)**              | Schedule agent retries or delayed actions with exact timing                                |
...
| **[Child Spawning](/concepts/child-spawning)**            | Agents dynamically spawn sub-agents or tool-call tasks                                     |
...
- [Child Spawning](/concepts/child-spawning): spawn tool-call tasks from agent loops
