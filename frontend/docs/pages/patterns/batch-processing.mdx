...
<Callout type="info">
  The batch processing pattern is [Fanout](/patterns/fanout) applied at
  scale. For fixed multi-stage processing (e.g., validate → transform → load),
  combine with [Pre-Determined
  Pipelines](/patterns/pre-determined-pipelines).
</Callout>
...
<Callout type="warning">
  ...
  See [Durable Workflows](/essentials/durable-workflows/durable-task-execution) for details.
</Callout>
