...
| -------------------------------------------------------- | ----------------------------------------------------------------------- |
| **[Child Spawning](/concepts/child-spawning)**               | Fan out to one task per item with automatic distribution across workers |
...
- [Child Spawning](/concepts/child-spawning): learn the fan-out API for batch processing
