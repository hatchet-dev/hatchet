...
<Callout type="info">
  ...
  across worker restarts. See [Durable Sleep](/concepts/durable-workflows/durable-task-execution/durable-sleep) and [Durable
  Events](/concepts/durable-workflows/durable-task-execution/durable-events) for API details.
</Callout>
...
<Cards>
  <Cards.Card title="Delayed Notifications" href="/concepts/durable-workflows/durable-task-execution/durable-sleep">
    Send a follow-up email or push notification hours or days after an initial
    action.
  </Cards.Card>
  <Cards.Card title="Human-in-the-Loop Approval" href="/concepts/durable-workflows/durable-task-execution/durable-events">
    Pause a workflow until a human approves, rejects, or provides input via an
    external event.
  </Cards.Card>
  <Cards.Card title="Scheduled Follow-Ups" href="/concepts/durable-workflows/durable-task-execution/durable-sleep">
    Implement drip campaigns, trial expiration checks, or periodic status polls
    with precise timing.
  </Cards.Card>
  <Cards.Card title="External System Callbacks" href="/concepts/durable-workflows/durable-task-execution/durable-events">
...
- [Durable Sleep](/concepts/durable-workflows/durable-task-execution/durable-sleep): pause for a fixed duration with exact timing guarantees
- [Durable Events](/concepts/durable-workflows/durable-task-execution/durable-events): wait for external signals with optional CEL filters
- [Event Conditions](/concepts/durable-workflows/directed-acyclic-graphs/event-conditions): combine long waits with branching logic
- [Sleep Conditions](/concepts/durable-workflows/directed-acyclic-graphs/sleep-conditions): delay tasks for a fixed duration in a DAG
- [Cycles](/patterns/cycles): use long waits inside iterative loops
