...
| -------------------------------------------------------------- | ------------------------------------------------------------------- |
| **[Event Triggers](/features/run-on-event)**                       | React to application events by name with optional payload filtering |
| **[Webhooks](/features/webhooks)**                                 | Receive external HTTP webhooks and route them to tasks              |
| **[Cron Triggers](/features/cron-runs)**                            | Schedule recurring tasks with cron expressions                      |
| **[Scheduled Runs](/features/scheduled-runs)**                      | Trigger one-time future execution at a specific time                |
...
| **[Inter-Service Triggering](/features/inter-service-triggering)**  | Trigger tasks across different services and worker pools            |
...
<Callout type="info">
  ...
  of Running Tasks](/features/running-tasks) for the complete list of trigger types
...
<Cards>
  <Cards.Card title="Branching" href="/patterns/patterns/branching">
  ...
  <Cards.Card title="Long Waits" href="/patterns/patterns/long-waits">
...
- [Event Triggers](/features/run-on-event): trigger tasks from application events
- [Webhooks](/features/webhooks): receive and process external webhooks
- [Cron Triggers](/features/cron-runs): set up recurring scheduled tasks
