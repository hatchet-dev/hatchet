...
<Callout type="info">
  The batch processing pattern is [Fanout](/patterns/patterns/fanout) applied at
  scale. For fixed multi-stage processing (e.g., validate → transform → load),
  combine with [Pre-Determined
  Pipelines](/patterns/patterns/pre-determined-pipelines).
</Callout>
...
<Cards>
  ...
  <Cards.Card title="RAG & Indexing" href="/patterns/use-cases/rag-and-indexing">
