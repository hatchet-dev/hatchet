...
| **[Event Triggers](/guide/run-on-event)**      | Start indexing automatically when new documents arrive                         |
| **[Cron Triggers](/guide/cron-runs)**          | Schedule periodic re-indexing or incremental updates                           |
| **[Bulk Run](/guide/bulk-run)**                | Trigger indexing for thousands of documents in a single API call               |
