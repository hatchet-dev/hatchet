...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.events.worker.event_trigger} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.on_event.workflow.run_workflow_on_event} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.workflows.on_event.run_workflow_on_event} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.events.event.event_trigger} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.on_event.event.pushing_an_event} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.run.event.pushing_an_event} />
  </Tabs.Tab>
</UniversalTabs>
