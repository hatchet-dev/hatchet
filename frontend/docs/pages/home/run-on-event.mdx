...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.on_event.workflow.run_workflow_on_event} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.on_event.workflow.accessing_the_filter_payload} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.workflows.on_event.accessing_the_filter_payload} />
  </Tabs.Tab>
</UniversalTabs>
