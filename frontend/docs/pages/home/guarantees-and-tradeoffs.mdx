...
✅ **Real-time Requests** - Sub-50ms task dispatch for hot workers with thousands of concurrent tasks  
...
✅ **Cloud or Air-gapped Environments** for flexible deployment options ([Hatchet Cloud](https://cloud.onhatchet.run) and [self-hosting](../self-hosting))

### Not a Good Fit

❌ **Extremely High Throughput** (consistently 10,000+ tasks/second)  
❌ **Sub-Millisecond Latency** requirements  
❌ **Simple Queuing** without workflow features  
