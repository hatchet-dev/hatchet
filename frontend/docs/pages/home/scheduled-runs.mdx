...
<Snippet src={snips.typescript.simple.schedule.create_a_scheduled_run} />
</Tabs.Tab>
<Tabs.Tab title="Go">
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.scheduled.programatic_sync.delete} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.simple.schedule.delete_a_scheduled_run} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.scheduled.programatic_sync.list} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.simple.schedule.list_scheduled_runs} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
