...
export const getStaticProps = ({}) => getSnippets([SimpleTs, SchedulePy, ScheduleTriggerGo]);
...
- [Programmatically](./scheduled-runs.mdx#programmatically-creating-scheduled-runs): Use the Hatchet SDKs to dynamically set the schedule of a workflow (i.e. customer defined schedule).
