...
<Snippet src={snips.go.streaming.worker} block="streaming" />
...
<Snippet src={snips.go.streaming.async_stream} block="consume" />
...
<Snippet src={snips.go.streaming.http_proxy} block="http_proxy" />
