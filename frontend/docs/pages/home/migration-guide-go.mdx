...
- **V0 SDK**: No type safety, uses `any` types
- **V1 Generics SDK**: Explicit generics with type parameters
- **V1 Reflection SDK**: Automatic type inference via reflection

### Task Definition
- **V0 SDK**: Manual workflow step registration
- **V1 Generics SDK**: Factory methods with type parameters
- **V1 Reflection SDK**: Direct function assignment with automatic typing

### Client Creation
- **V0 SDK**: `client.New()`
- **V1 Generics SDK**: `v1.NewHatchetClient()`
- **V1 Reflection SDK**: `hatchet.NewClient()`
