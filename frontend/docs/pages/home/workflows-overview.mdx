...
import WorkflowComparison from "@/components/WorkflowComparisonWrapper";
...
Hatchet offers two types of workflows to cover different needs. Toggle between them to compare:
