...
<Callout type="info">
  Workflows can be as simple as a single task or as complex as dozens of tasks with branching, fan-out, and conditional logic. Start simple and compose as needed.
</Callout>
...
<Callout type="warning">
  If your workflow can be expressed as a DAG, **prefer regular workflows**. They're simpler, inherently deterministic, and easier to debug. Use durable workflows when you need inline pausing, long waits, or logic that can't be expressed as a static graph.
</Callout>
...
<Cards>
  ...
  <Cards.Card title="DAGs in Detail" href="/home/dags">
    Define multi-task workflows with dependencies, parent outputs, and parallel execution.
  </Cards.Card>
  <Cards.Card title="Child Spawning" href="/home/child-spawning">
    Dynamically create child tasks at runtime for fan-out, loops, and agent patterns.
  </Cards.Card>
