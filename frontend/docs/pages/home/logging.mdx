...
export const getStaticProps = ({}) =>
  getSnippets([LoggerClientPy, LoggerWorkflowPy, LoggerWorkflowTs, ByoLoggerTs]);
...
{/* <UniversalTabs items={['Python', 'TypeScript', 'Go']}> TODO V1 DOCS -- Add Go logging and add this tab back */}
  <Tabs.Tab>
...
This has the benefit of being easy to use out of the box (no setup required!), but it's limited in its flexibiliy and how pluggable it is with your existing logging setup. Hatchet also allows you to "bring your own" logger when you define a workflow:
