...
<Snippet src={snips.python.logger.client.rootlogger} />
...
<Snippet src={snips.python.logger.workflow.loggingworkflow} />
...
<Snippet src={snips.python.logger.workflow.contextlogger} />
