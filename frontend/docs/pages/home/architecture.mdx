...
The **API & gRPC Server** serves as the primary interface for triggering workflows and managing Hatchet resources. It exposes REST endpoints and gRPC connections that your applications use to:
