...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snippets.python.conditions.worker} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow}
     
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
      src={snippets.go.workflows.complex_conditions}
...
Note that in this task, we rely on `ctx.was_skipped` to determine if a task was skipped.
  ...
  <Tabs.Tab title="Typescript">
<Snippet src={snippets.typescript.dag_match_condition.complex_workflow} />
  </Tabs.Tab>
    <Tabs.Tab title="Go">
    <Snippet src={snippets.go.workflows.complex_conditions} />
  </Tabs.Tab>
