...
<Callout type="warning">
  A task cancelled by a `cancel_if` operator will behave the same as any other cancellation in Hatchet, meaning that downstream tasks will be cancelled as well.
</Callout>
