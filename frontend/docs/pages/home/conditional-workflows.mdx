...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow.create_a_workflow}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
      src={snippets.go.workflows.complex_conditions.create_a_workflow}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow.add_base_task}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
      src={snippets.go.workflows.complex_conditions.add_base_task}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow.add_wait_for_sleep}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow.add_skip_on_event}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
      src={snippets.go.workflows.complex_conditions.add_skip_on_event}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow.add_branching}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
      src={snippets.go.workflows.complex_conditions.add_branching}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.dag_match_condition.complex_workflow.add_wait_for_event}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
