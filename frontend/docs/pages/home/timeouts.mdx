...
<UniversalTabs items={['Python', 'Typescript']}>
  ...
  <Tabs.Tab>
  <Snippet src={snippets.typescript.with_timeouts.workflow.declaring_a_task} />

  </Tabs.Tab>
  <Tabs.Tab>
    {/* TODO: Go execution_timeout pattern needs to be found in new structure */}
...
<UniversalTabs items={['Python', 'Typescript']}>
  ...
  <Tabs.Tab>
  {/* TODO: Go refresh_timeout pattern needs to be found in new structure */}
