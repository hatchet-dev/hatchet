...
<Snippet src={snippets.python.durable_event.worker} />

</Tabs.Tab>
<Tabs.Tab title="Typescript">

<Snippet src={snippets.typescript.durable_event.workflow} />

</Tabs.Tab>
<Tabs.Tab title="Go">

<Snippet src={snippets.go.workflows.durable_event} />
...
<Snippet
  src={snippets.python.durable_event.worker}
...
<Snippet
  src={snippets.typescript.durable_event.workflow}
...
<Snippet
  src={snippets.go.workflows.durable_event}
