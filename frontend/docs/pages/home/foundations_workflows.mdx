...
Now that you understand the foundational [Step](./foundations_steps.mdx) concept, you can combine these foundational building blocks into a structured sequence of tasks, known as a **workflow**.
