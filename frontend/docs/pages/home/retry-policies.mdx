...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet src={snips.python.retries.worker.simple_step_retries} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.typescript.retries.workflow.simple_step_retries} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows.retries.simple_step_retries} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet src={snips.python.retries.worker.retries_with_count} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.typescript.retries.workflow.retries_with_count} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows.retries.retries_with_count} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.retries.worker.retries_with_backoff} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.retries.workflow.retries_with_backoff} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.workflows.retries.retries_with_backoff} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.non_retryable.worker.non_retryable_task} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.non_retryable.workflow.non_retrying_task} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.workflows.non_retryable_error.non_retryable_error} />
  </Tabs.Tab>
</UniversalTabs>
