...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab>
    <Snippet
      src={snippets.typescript.retries.workflow.simple_step_retries}
    />
  </Tabs.Tab>
  <Tabs.Tab>
    {/* TODO: Go retries simple_step_retries pattern needs to be found in new structure */}
    <Snippet src={snippets.go.z_v0["retries-with-backoff"].main.backoff} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab>
    <Snippet
      src={snippets.typescript.retries.workflow.retries_with_count}
    />
  </Tabs.Tab>
  <Tabs.Tab>
    {/* TODO: Go retries retries_with_count pattern needs to be found in new structure */}
    <Snippet src={snippets.go.z_v0["retries-with-backoff"].main.backoff} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.retries.workflow.retries_with_backoff}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.z_v0["retries-with-backoff"].main.backoff} />
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet
      src={snippets.python.non_retryable.worker.non_retryable_task}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
  ...
  <Tabs.Tab title="Go">
    {/* TODO: Go non_retryable_error pattern needs to be found in new structure */}
    <Snippet
      src={snippets.go.z_v0["on-failure"].main.on_failure_step}
    />
  </Tabs.Tab>
</UniversalTabs>
