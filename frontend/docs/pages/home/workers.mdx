...
<Callout type="info">
  For self-hosted users, you may need to set other gRPC configuration options to ensure your worker can connect to the Hatchet engine. See the [Self-Hosting](../self-hosting/worker-configuration-options.mdx) docs for more information.
</Callout>
