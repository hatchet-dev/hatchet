...
<Callout type="info">
  For Self-Hosting users, you may need to set GRPC other configuration options to ensure your worker can connect to the Hatchet engine. See the [Self-Hosting](../self-hosting/worker-configuration-options.mdx) docs for more information.
</Callout>
