...
<Snippet src={snips.python.rate_limit.worker.dynamic} />
...
<Snippet src={snips.typescript.rate_limit.workflow.dynamic} />

  </Tabs.Tab>
  <Tabs.Tab>
> Note: Go requires both a key and KeyExpr be set and the LimitValueExpr must be a CEL.

<Snippet src={snips.go.workflows.ratelimit.dynamic_rate_limit} />
...
<Snippet src={snips.typescript.rate_limit.workflow.upsert_rate_limit} />

  </Tabs.Tab>
  <Tabs.Tab>

    <Snippet src={snips.go.workflows.ratelimit.upsert_rate_limit} />
...
<Snippet src={snips.python.rate_limit.worker.static} />

  </Tabs.Tab>
  <Tabs.Tab>

<Snippet src={snips.typescript.rate_limit.workflow.static} />

  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows.ratelimit.static_rate_limit} />
