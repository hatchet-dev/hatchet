...
<UniversalTabs items={["Python-Sync", "Python-Async", "Typescript", "Go"]}>
  <Tabs.Tab title="Python-Sync">
    <Snippet src={snippets.python.cron.workflow_definition.workflow_definition_cron_trigger} />
  </Tabs.Tab>
  ...
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.workflows.on_cron.workflow_definition_cron_trigger} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python-Sync", "Python-Async", "Typescript", "Go"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.simple.client_run.client_run_methods} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.z_v0.cron_programmatic.main.create} />
  </Tabs.Tab>
</UniversalTabs>
