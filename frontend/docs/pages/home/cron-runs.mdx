...
<UniversalTabs items={["Python-Sync", "Python-Async", "Typescript", "Go"]}>
  <Tabs.Tab title="Python-Sync">
    <Snippet
      src={
        snips.python.cron.workflow_definition.workflow_definition_cron_trigger
      }
    />
  </Tabs.Tab>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.on_cron.workflow.run_workflow_on_cron} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet
      src={snips.go.workflows.on_cron.workflow_definition_cron_trigger}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python-Sync", "Python-Async", "Typescript", "Go"]}>
  <Tabs.Tab title="Python-Sync">
    <Snippet src={snips.python.cron.programatic_sync.create} />
  </Tabs.Tab>
  <Tabs.Tab title="Python-Async">
    <Snippet src={snips.python.cron.programatic_async.create} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.simple.cron.create} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.run.cron.create} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python-Sync", "Python-Async", "Typescript", "Go"]}>
  <Tabs.Tab title="Python-Sync">
    <Snippet src={snips.python.cron.programatic_sync.delete} />
  </Tabs.Tab>
  <Tabs.Tab title="Python-Async">
    <Snippet src={snips.python.cron.programatic_async.delete} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.simple.cron.delete} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.run.cron.delete} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python-Sync", "Python-Async", "Typescript", "Go"]}>
  <Tabs.Tab title="Python-Sync">
    <Snippet src={snips.python.cron.programatic_sync.list} />
  </Tabs.Tab>
  <Tabs.Tab title="Python-Async">
    <Snippet src={snips.python.cron.programatic_async.list} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.simple.cron.list} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.run.cron.list} />
  </Tabs.Tab>
</UniversalTabs>
