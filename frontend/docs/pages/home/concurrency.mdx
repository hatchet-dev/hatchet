...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab>
    <Snippet
      src={snippets.typescript["concurrency-rr"].workflow.concurrency_strategy_with_key}
    />
  </Tabs.Tab>
  <Tabs.Tab>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  ...
  <Tabs.Tab>
    <Snippet
      src={snippets.typescript["concurrency-rr"].workflow.multiple_concurrency_keys}
    />
  </Tabs.Tab>
  <Tabs.Tab>
