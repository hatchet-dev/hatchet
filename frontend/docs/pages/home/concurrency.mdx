...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet
      src={snippets.python.concurrency_limit_rr.worker.concurrency_strategy_with_key}
    />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet
      src={snippets.typescript.concurrency_rr.workflow.concurrency_strategy_with_key}
    />
  </Tabs.Tab>
  <Tabs.Tab>
    {/* TODO: Go concurrency_strategy_with_key pattern needs to be found in new structure */}
    <Snippet
      src={snippets.go.workflows.ratelimit.upsert_rate_limit}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet
      src={snippets.python.concurrency_workflow_level.worker.multiple_concurrency_keys}
    />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet
      src={snippets.typescript.concurrency_rr.workflow.multiple_concurrency_keys}
    />
  </Tabs.Tab>
  <Tabs.Tab>
    {/* TODO: Go multiple_concurrency_keys pattern needs to be found in new structure */}
    <Snippet
      src={snippets.go.workflows.ratelimit.dynamic_rate_limit}
    />
  </Tabs.Tab>
</UniversalTabs>
