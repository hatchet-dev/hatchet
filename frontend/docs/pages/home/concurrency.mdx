...
export const TS = "examples/typescript/concurrency-rr/workflow.ts";
export const PY = "examples/python/concurrency_limit_rr/worker.py";
export const GO = "examples/v1/workflows/concurrency-rr.go";
export const MultiplePY = "examples/python/concurrency_workflow_level/worker.py";
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet src={snips.python.concurrency_limit_rr.worker["Concurrency Strategy With Key"]} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.typescript['concurrency-rr'].workflow['Concurrency Strategy With Key']} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows['concurrency-rr']['Concurrency Strategy With Key']} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet src={snips.python.concurrency_workflow_level.worker['Multiple Concurrency Keys']} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.typescript['concurrency-rr'].workflow["Multiple Concurrency Keys"]} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows['concurrency-rr']['Multiple Concurrency Keys']} />
  </Tabs.Tab>
</UniversalTabs>
