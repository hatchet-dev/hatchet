...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet src={snips.python.concurrency_limit_rr.worker.concurrency_strategy_with_key} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.typescript.concurrency_rr.workflow.concurrency_strategy_with_key} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows.concurrency_rr.concurrency_strategy_with_key} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab>
    <Snippet src={snips.python.concurrency_workflow_level.worker.multiple_concurrency_keys} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.typescript.concurrency_rr.workflow.multiple_concurrency_keys} />
  </Tabs.Tab>
  <Tabs.Tab>
    <Snippet src={snips.go.workflows.concurrency_rr.multiple_concurrency_keys} />
  </Tabs.Tab>
</UniversalTabs>
