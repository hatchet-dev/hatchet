...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  ...
  <Tabs.Tab>
    <Snippet src={snippets.ruby.concurrency_limit_rr.worker.concurrency_strategy_with_key} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  ...
  <Tabs.Tab>
    <Snippet src={snippets.ruby.concurrency_workflow_level.worker.multiple_concurrency_keys} />
  </Tabs.Tab>
</UniversalTabs>
