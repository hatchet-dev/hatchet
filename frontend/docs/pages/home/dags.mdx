...
<Callout variant="info">
  The Workflow return object can be interacted with in the same way as a [task](./your-first-task.mdx), 
  however, it can only take a subset of options which are applied at the task level.
</Callout>
