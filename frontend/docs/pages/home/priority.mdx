...
/>
  ...
  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.priority.worker.default_priority} />
  </Tabs.Tab>
</UniversalTabs>
...
<Snippet src={snippets.typescript.priority.run.run_a_task_with_a_priority} />
  ...
  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.priority.trigger.runtime_priority} />
  </Tabs.Tab>
</UniversalTabs>
...
<Snippet src={snippets.typescript.priority.run.schedule_and_cron} />
  ...
  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.priority.trigger.scheduled_priority} />
  </Tabs.Tab>
</UniversalTabs>
