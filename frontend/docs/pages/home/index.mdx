...
| **Concurrent Tasks**                        | Thousands | Limited  | Limited | Thousands    |
...
Hatchet has been battle-tested in production environments, processing billions of tasks per month for scale-ups and enterprises across various industries. Our open source offering is deployed over 10k times per month, while our open source offering supports hundreds of companies running at scale.
