...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.cancellation.worker['Checking exit flag']} />
    <Snippet src={snips.python.cancellation.worker['Self-cancelling task']} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snips.typescript.cancellations.workflow['Declaring a Task']} />
    <Snippet src={snips.typescript.cancellations.workflow['Abort Signal']} />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snips.go.workflows.cancellations['Cancelled task']} />
  </Tabs.Tab>
</UniversalTabs>
