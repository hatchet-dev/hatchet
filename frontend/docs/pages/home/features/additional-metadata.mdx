...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="streaming-by-additional-metadata"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="streaming-by-additional-metadata"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Go" blockName="streaming-by-additional-metadata"/>
  </Tabs.Tab>
</UniversalTabs>
  </Tabs.Tab>
  <Tabs.Tab>
