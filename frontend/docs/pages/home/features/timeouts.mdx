...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="scheduling-timeouts"/>
  </Tabs.Tab>
  <Tabs.Tab>
```typescript
...
```
  ...
  <Tabs.Tab>
    <CodeCell language="Go" blockName="scheduling-timeouts"/>
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="step-timeouts"/>
  </Tabs.Tab>
  <Tabs.Tab>
```typescript
...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="refreshing-timeouts"/>
  </Tabs.Tab>
  <Tabs.Tab>
```typescript
const myStep: CreateStep<any, any> = {
