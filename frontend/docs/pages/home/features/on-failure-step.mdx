...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="defining-an-on-failure-step"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="defining-an-on-failure-step"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Golang" blockName="defining-an-on-failure-step"/>
  </Tabs.Tab>
</UniversalTabs>
