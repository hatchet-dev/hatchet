...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="setting-sticky-assignment"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="setting-sticky-assignment"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Go" blockName="setting-sticky-assignment"/>
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  ...
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="sticky-child-workflows"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Go" blockName="setting-sticky-assignment"/>
  </Tabs.Tab>
