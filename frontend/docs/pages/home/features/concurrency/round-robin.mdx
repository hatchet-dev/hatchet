...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="concurrency_group_red_robin"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="concurrency_group_red_robin"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Go" blockName="concurrency_group_red_robin"/>
  </Tabs.Tab>
</UniversalTabs>
