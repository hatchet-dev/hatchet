...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="setting-concurrency-on-workers"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="setting-concurrency-on-workers"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Go" blockName="setting-concurrency-on-workers"/>
  </Tabs.Tab>
</UniversalTabs>
