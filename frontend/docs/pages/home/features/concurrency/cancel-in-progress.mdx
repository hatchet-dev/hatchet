...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="concurrency_cancel_in_progress"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="concurrency_cancel_in_progress"/>
  </Tabs.Tab>
  <Tabs.Tab> 
    <CodeCell language="Go" blockName="concurrency_cancel_in_progress"/>
  </Tabs.Tab>
</UniversalTabs>
