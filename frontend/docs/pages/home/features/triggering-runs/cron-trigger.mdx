...
export const CronTriggerGoProgrammatic = {
  ...
  branch: "belanger/cron-and-schedule-fixes",
};
...
- [Dynamic Programmatically](./cron-trigger.mdx#programmatically-creating-cron-triggers): Use the Hatchet SDKs to dynamically set the cron schedule of a workflow (i.e. customer defined schedule).
