...
export const getStaticProps = ({}) => getSnippets([FanoutWorker]);
...
To loop through a list and create a new workflow per element in the list, you can either spawn workflows in a loop or (preferably) spawn them in bulk. For example:

<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>

<GithubSnippet src={FanoutWorker} target="FanoutParent" />
