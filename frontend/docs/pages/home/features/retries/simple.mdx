...
<UniversalTabs items={['Python', 'Typescript', 'Go']}>
  <Tabs.Tab>
    <CodeCell language="Python" blockName="how-to-use-step-level-retries"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Typescript" blockName="how-to-use-step-level-retries"/>
  </Tabs.Tab>
  <Tabs.Tab>
    <CodeCell language="Go" blockName="how-to-use-step-level-retries"/>
  </Tabs.Tab>
</UniversalTabs>
