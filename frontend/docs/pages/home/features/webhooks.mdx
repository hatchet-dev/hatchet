...
Hatchet expects you to use a long-running app to process your workflows. This does not work on serverless environments like AWS Lambda, Vercel, GCP Cloud Functions, CloudFlare Workers, and many more.

To run workflows on a serverless environment, you can use webhooks.\
