...
<Snippet src={snips.python.opentelemetry_instrumentation.langfuse.client} block="configure_langfuse" />

Next, configure your tracer provider:

<Snippet src={snips.python.opentelemetry_instrumentation.langfuse.client} block="configure_tracer_provider" />
...
<Snippet src={snips.python.opentelemetry_instrumentation.langfuse.client} block="create_openai_client" />

And that's it! Now you're ready to instrument your Hatchet workers with Langfuse. For example, create a task like this:

<Snippet src={snips.python.opentelemetry_instrumentation.langfuse.worker} block="task" />
...
<Snippet src={snips.python.opentelemetry_instrumentation.langfuse.trigger} block="trigger_task" />
