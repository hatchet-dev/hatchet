...
<Callout type="info">
  ...
  Pipelines](/home/patterns/pre-determined-pipelines). The stages (ingest,
  chunk, embed, index) are fixed and map directly to a DAG. Use
  [Fanout](/home/patterns/fanout) within the chunking stage to parallelize.
</Callout>
...
<Callout type="warning">
  ...
  [Concurrency Control](/home/concurrency) to limit how many run simultaneously.
</Callout>
...
<Cards>
  <Cards.Card
    ...
    href="/home/patterns/pre-determined-pipelines"
  >
