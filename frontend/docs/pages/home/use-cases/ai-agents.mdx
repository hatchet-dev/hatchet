...
<Callout type="info">
  The agent loop pattern is a [Cycle](/home/patterns/cycles). Each iteration
  spawns a new child run via `RunChild`. Combined with [Durable
  Execution](/home/durable-workflows-overview), completed iterations survive
...
<Callout type="warning">
  ...
  bounds, an agent can loop indefinitely. See [Timeouts](/home/timeouts) for
  configuration.
</Callout>
