...
<Callout type="info">
  The batch processing pattern is [Fanout](/home/patterns/fanout) applied at
  scale. For fixed multi-stage processing (e.g., validate → transform → load),
  combine with [Pre-Determined
  Pipelines](/home/patterns/pre-determined-pipelines).
</Callout>
...
<Callout type="warning">
  ...
  See [Durable Workflows](/home/durable-workflows-overview) for details.
</Callout>
