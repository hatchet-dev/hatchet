...
<Callout type="info">
  You can access help documentation by pressing the `h` key within the TUI. This will display a list of available commands and their descriptions.
</Callout>
