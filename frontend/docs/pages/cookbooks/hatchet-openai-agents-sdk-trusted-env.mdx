...
These are the same tools used in the [Claude Agent SDK](/cookbooks/hatchet-claude-agent-sdk-trusted-env) version of this pattern. The difference is how the agent receives and calls them.
...
<UniversalTabs items={["Python", "Typescript"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.support_agent_tools.tools.lookup_customer} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snippets.python.support_agent_tools.tools.check_order_status} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.support_agent_tools.tools.check_order_status} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript"]}>
  ...
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.support_agent_tools.tools.create_ticket} />
  </Tabs.Tab>
</UniversalTabs>
...
<UniversalTabs items={["Python", "Typescript"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snippets.python.support_agent_tools.tools.create_openai_tools} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet src={snippets.typescript.support_agent_tools.tools.create_openai_tools} />
  </Tabs.Tab>
</UniversalTabs>
...
- [Claude Agent SDK](/cookbooks/hatchet-claude-agent-sdk-trusted-env): the same support scenario with the Claude Agent SDK, including MCP server creation and allowed-tools configuration.
