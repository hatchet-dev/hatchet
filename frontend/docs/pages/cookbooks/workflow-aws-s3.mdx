...
<FanoutDiagram
  ...
  parentSubLabel="cron trigger"
  midNodes={[
    {
      label: "S3::ListObjects",
      subLabel: "bucket-0",
      leaves: [
        { label: "Process", subLabel: "bucket-0/object-0.png" },
        { label: "Process", subLabel: "bucket-0/object-N.png" },
      ],
    },
    {
      label: "S3::ListObjects",
...
<FanoutDiagram
  ...
  parentSubLabel="cron trigger"
  childLabels={["bucket-0", "bucket-1", "bucket-N"]}
  showCollect={false}
/>

Taking all of this into account, we define our `fetch_s3_buckets` workflow as follows:
...
<FanoutDiagram
  parentLabel="List objects"
  parentSubLabel="input.bucket"
  childLabels={[
    "Download &\nprocess",
    "Download &\nprocess",
    "Download &\nprocess",
