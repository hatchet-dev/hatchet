...
- [Fanout](/guides/fanout): dynamically spawn tasks instead of choosing between fixed branches
- [Pre-Determined Pipelines](/guides/pre-determined-pipelines): fixed-structure pipelines without branching
