...
<Callout type="info">
  ...
  across worker restarts. See [Durable
  Sleep](/concepts/durable-workflows/durable-task-execution/durable-sleep) and
  [Durable
  Events](/concepts/durable-workflows/durable-task-execution/durable-events) for
  API details.
</Callout>
...
<Cards>
  ...
  <Cards.Card
    title="External System Callbacks"
    href="/concepts/durable-workflows/durable-task-execution/durable-events"
  >
...
- [Cycles](/guides/cycles): use long waits inside iterative loops
