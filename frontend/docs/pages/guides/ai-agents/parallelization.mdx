...
Hatchet distributes child runs across your worker fleet. The parent's slot is [freed while children execute](/concepts/durable-workflows/durable-task-execution/task-eviction), so you don't hold resources during parallel work.
...
### Step 2: Sectioning — parallel concerns
...
### Step 3: Voting — parallel consensus
