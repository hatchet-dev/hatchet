...
| Tool calls          | [Child tasks](/v1/durable-workflows/dag-child-spawning): sequential or [parallel](/v1/durable-workflows/dag-child-spawning) |
| Human approval gate | [WaitForEvent](/v1/durable-workflows/durable-events): slot freed while waiting                                                                     |
