...
A **pre-determined pipeline** is a workflow where the sequence of tasks and their dependencies are defined ahead of time as a Directed Acyclic Graph (DAG). Unlike [fanout](/guides/fanout), where children are spawned dynamically at runtime, pipelines have a fixed structure that is known before execution begins.
...
<Cards>
  ...
  <Cards.Card
    ...
    href="/guides/document-processing"
  >
...
- [Fanout](/guides/fanout): dynamically spawn tasks at runtime instead
