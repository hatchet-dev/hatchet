...
<Callout type="info">
  ...
  Pipelines](/guides/pre-determined-pipelines). The stages (ingest, chunk,
  embed, index) are fixed and map directly to a DAG. Use
  [Fanout](/guides/fanout) within the chunking stage to parallelize.
</Callout>
