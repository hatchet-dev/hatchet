...
<Callout type="info">
  ...
  Pipelines](/concepts/durable-workflows/directed-acyclic-graphs). The stages (ingest, chunk,
  embed, index) are fixed and map directly to a DAG. Use
  [Fanout](/concepts/durable-workflows/directed-acyclic-graphs/child-spawning) within the chunking stage to parallelize.
</Callout>
...
<Cards>
  ...
  <Cards.Card title="Cycles" href="/concepts/durable-workflows/durable-task-execution/child-spawning">
