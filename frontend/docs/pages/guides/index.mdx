...
<Cards>
  <Cards.Card title="AI Agents" href="/guides/ai-agents">
    Build agents that reason, act, and observe in a loop. Covers reasoning loops,
    routing, multi-agent orchestration, and parallelization.
  </Cards.Card>
  <Cards.Card title="Human-in-the-Loop" href="/guides/human-in-the-loop">
    Pause a task for human review or approval, freeing the worker slot until
    the decision arrives. The task resumes exactly where it left off.
  </Cards.Card>
...
<Cards>
  <Cards.Card title="Troubleshooting Workers" href="/guides/troubleshooting-workers">
