...
const Logo = ({ color }: { color: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 198 49" width="140" height="40" fill="none">
    <path
      fill={color}
    ...
    >
      ...
      >
        {sections.map((s) => (
          ...
          >
            <span style={{ fontSize: "0.9375rem", fontWeight: 600, color: t.fg }}>
              {s.title}
            </span>
            <span style={{ fontSize: "0.8125rem", color: t.muted, lineHeight: 1.4 }}>
              {s.description}
            </span>
          </Link>
        ))}
