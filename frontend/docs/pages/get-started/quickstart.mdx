...
See the [full setup guide](/get-started/using-coding-agents) for manual configuration options.
...
Once you've completed the quickstart, you can explore a more in-depth walkthrough of Hatchet using the [Advanced Setup](/get-started/advanced) guide.
