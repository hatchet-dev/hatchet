...
At minimum, a task needs a name and a function. The returned object is a **runnable** - you'll use it directly to [trigger](/get-started/running-your-task) the task.
...
Now that you have a task defined, [create a worker](/get-started/workers) to execute it.
