...
<Callout type="info">
  ...
  [Hatchet Cloud Quickstart](/get-started/quickstart) or the [Self-Hosting
...
Continue to the next section to learn how to [create your first task](/get-started/your-first-task)
