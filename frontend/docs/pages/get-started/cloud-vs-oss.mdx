...
- **[Quickstart](/get-started/quickstart)**: run a worker and trigger your first workflow
- **[Architecture & Guarantees](/get-started/architecture-and-guarantees)**: understand reliability semantics and tradeoffs
