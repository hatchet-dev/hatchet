...
export const getStaticProps = ({}) => getSnippets([SimpleWorker, FanoutWorker]);
...
<GithubSnippet src={SimpleWorker} target="Declaring a Workflow" />

Once you've declared your workflow, you can bind tasks to it:

<GithubSnippet src={SimpleWorker} target="Binding a Task to a Workflow" />
