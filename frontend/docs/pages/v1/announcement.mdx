...
## 🪓 Hatchet `v1` is nearly here!

<Callout type="info" emoji="🚀">
  The first Hatchet Launch Week is coming up! From March 24th to March 28th, we
  will be highlighting a new feature or performance improvement in the v1 engine
  each day. You can get updates in our Discord
  [here](https://discord.gg/ZMeUafwH89) and we will be updating the top of our
  README [here](https://github.com/hatchet-dev/hatchet) with new announcements.
</Callout>
...
<img
  width="1591"
  alt="image"
  src="https://github.com/user-attachments/assets/55f6b343-e9a9-4d6b-9c03-43eba105357d"
/>
