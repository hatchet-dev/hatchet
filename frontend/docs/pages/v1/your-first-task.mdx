...
Now that you have a task defined, [create a worker](/v1/workers) to execute it.

Want to dive deeper? The [Tasks concepts page](/v1/runnables/tasks) covers triggering methods, input/output, the context object, and how tasks execute on workers.
