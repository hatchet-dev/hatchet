...
## Creating a Workflow Declaration Stub (Recommended)

The recommended way to run workflows from external services in most cases is to create a workflow declaration stub. A workflow declaration stub is the minimal amount of code needed to declare a workflow that matches the declaration on the worker (i.e. name and input/output types).
