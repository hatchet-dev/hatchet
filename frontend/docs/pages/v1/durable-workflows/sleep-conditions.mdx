...
<Callout type="info">
  ...
  Sleep](/v1/durable-workflows/durable-sleep). In a
...
Sleep conditions can be combined with other conditions using or groups. For example, you can wait for _either_ a sleep duration or an event (whichever comes first). See [Combining Conditions](/v1/durable-workflows/combining-conditions) for details.
