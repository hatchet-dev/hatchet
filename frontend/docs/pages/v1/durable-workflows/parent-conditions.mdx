...
The following diagram shows how a workflow branches into different paths based on conditions evaluated at runtime.
...
Parent conditions can be combined with event and sleep conditions using or groups. See [Combining Conditions](/v1/durable-workflows/combining-conditions) for details.
