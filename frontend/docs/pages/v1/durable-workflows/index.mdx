...
Hatchet supports two patterns for building durable workflows, and you can [mix them](/v1/durable-workflows/mixing-patterns) within the same application. Both are durable — the difference is how you express the work. The key difference is whether you know the **shape of work** ahead of time.

<DurableWorkflowComparisonDiagram />

**Durable task execution** — The shape of work is **dynamic**. A single long-running function that can pause for time or external signals (`SleepFor`, `WaitForEvent`) and [spawn child tasks](/v1/durable-workflows/child-spawning) at runtime. Use durable tasks when:
...
<Cards>
  <Cards.Card
    ...
    href="/v1/durable-workflows/durable-task-execution"
  >
  ...
  <Cards.Card
    ...
    href="/v1/durable-workflows/mixing-patterns"
  >
