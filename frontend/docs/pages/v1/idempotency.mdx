...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  <Tabs.Tab>
    <Snippet
      src={
        snippets.python.idempotency.worker.idempotency
      }
    />
  </Tabs.Tab>
  <Tabs.Tab>
...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  <Tabs.Tab>
    <Snippet
      src={
        snippets.python.idempotency.trigger.trigger
      }
    />
  </Tabs.Tab>
  <Tabs.Tab>
...
In other cases, such as triggering by events, the idempotency collision will be swallowed, and no additional runs will be created by the event will still be ingested correctly without an error being raised.
