...
- **Pre-configured sources**: Only require a webhook secret
...
The following sources have built-in presets that handle authentication and payload parsing automatically. When creating a webhook, select the matching source to apply these defaults.
