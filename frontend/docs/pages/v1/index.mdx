...
- **AI agents** — features like [webhooks](/v1/webhooks), [child spawning](/v1/durable-workflows/child-spawning), and dynamic workflows are designed to support agentic patterns.
