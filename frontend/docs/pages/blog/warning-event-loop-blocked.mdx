...
<Snippet src={snippets.python.blocked_async.debugging} />
...
<Snippet
  src={snippets.python.blocked_async.blocking_example_worker}
...
<Snippet
  src={snippets.python.blocked_async.blocking_example_trigger}
