...
<Snippet src={snippets.typescript.migration_guides.mergent.running_a_task_mergent} />

#### After (Hatchet)

<Snippet src={snippets.typescript.migration_guides.mergent.running_a_task_hatchet} />
...
<Snippet src={snippets.python.migration_guides.mergent.running_a_task_hatchet} />
