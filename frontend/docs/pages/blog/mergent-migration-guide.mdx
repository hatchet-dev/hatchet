...
<Snippet src={snips.typescript.migration_guides.mergent.running_a_task_mergent} />

#### After (Hatchet)

The primary way of triggering tasks in Hatchet is via the SDK.

<Snippet src={snips.typescript.migration_guides.mergent.running_a_task_hatchet} />
