...
import { GithubSnippet, GithubSnippetV1, getSnippets } from "@/components/code";
...
export const Py = {
  path: "examples/migration-guides/mergent.py",
};
...
<GithubSnippetV1 src={snips.typescript.simple.run['Spawning Tasks from within a Task']} />
...
<GithubSnippet src={snips.typescript.simple.run} />
...
<Tabs.Tab title="Typescript">
#### Before (Mergent)
<GithubSnippet src={Ts}  target="Before (Mergent)" />

After (Hatchet)

<GithubSnippet src={Ts} target="After (Hatchet)" />

</Tabs.Tab>
<Tabs.Tab title="Python">
#### Before (Mergent)
<GithubSnippet src={Py}  target="Before (Mergent)" />

#### After (Hatchet)

<GithubSnippet src={Py} target="After (Hatchet)" />

</Tabs.Tab>
<Tabs.Tab title="Go">
#### Before (Mergent)
<GithubSnippet src={Go}  target="Before (Mergent)" />

#### After (Hatchet)

<GithubSnippet src={Go} target="After (Hatchet)" />
...
<GithubSnippet src={Ts} target="Running a task (Mergent)" />
...
<Tabs.Tab title="Go">
#### Before (Mergent)
<GithubSnippet src={Go}  target="Running a task (Mergent)" />
...
<Tabs.Tab title="Typescript">
#### Before (Mergent)
<GithubSnippet src={Ts}  target="Scheduling tasks (Mergent)" />

#### After (Hatchet)

<GithubSnippet src={Ts}  target="Scheduling tasks (Hatchet)" />
</Tabs.Tab>
<Tabs.Tab title="Python">
#### Before (Mergent)
<GithubSnippet src={Py}  target="Scheduling tasks (Mergent)" />

#### After (Hatchet)

<GithubSnippet src={Py}  target="Scheduling tasks (Hatchet)" />
</Tabs.Tab>
<Tabs.Tab title="Go">

#### After (Hatchet)

<GithubSnippet src={Go}  target="Scheduling tasks (Hatchet)" />
</Tabs.Tab>
</UniversalTabs>
