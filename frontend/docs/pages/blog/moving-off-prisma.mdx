...
<div id="1">
  [1] The core of our queue has almost always been raw SQL, and this post is
  focused on the parts of our service which are still high volume, but don't
  implement the queue.
</div>
