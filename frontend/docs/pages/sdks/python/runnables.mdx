...
| Name           | Description                                                              |
| -------------- | ------------------------------------------------------------------------ |
| `mock_run`     | Mimic the execution of a task. This method is intended for unit testing. |
| `aio_mock_run` | Mimic the execution of a task. This method is intended for unit testing. |
...
| `parent_outputs`      | `dict[str, JSONSerializableMapping] \| None` | Outputs from parent tasks, if any. This is useful for mimicking DAG functionality.                                                                   | `None`  |
