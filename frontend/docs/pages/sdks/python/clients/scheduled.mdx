...
**Returns:** `ScheduledWorkflows`: The created scheduled workflow instance.
...
**Returns:** `ScheduledWorkflows`: The requested scheduled workflow instance.
...
**Returns:** `List[ScheduledWorkflows]`: A list of scheduled workflows matching the criteria.
