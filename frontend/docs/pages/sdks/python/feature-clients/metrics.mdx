...
| `aio_get_tenant_prometheus_metrics` | Scrape Prometheus metrics for the tenant. Returns the metrics in Prometheus text format.  |
...
| `get_tenant_prometheus_metrics`     | Scrape Prometheus metrics for the tenant. Returns the metrics in Prometheus text format.  |
...
| Type             | Description               |
| ---------------- | ------------------------- |
| `dict[str, int]` | The current queue metrics |
...
#### `aio_get_tenant_prometheus_metrics`
