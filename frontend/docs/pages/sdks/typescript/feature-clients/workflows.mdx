...
| ---------- | ---------------------------------------------------------------------------------------------- | --------------------------------- |
| `workflow` | \| `string` \| `Workflow` \| `WorkflowDefinition` \| `BaseWorkflowDeclaration`\<`any`, `any`\> | The workflow name, ID, or object. |
...
| Parameter  | Type                                                                | Description                       |
| ---------- | ------------------------------------------------------------------- | --------------------------------- |
| `workflow` | `string` \| `Workflow` \| `BaseWorkflowDeclaration`\<`any`, `any`\> | The workflow name, ID, or object. |
...
| Parameter      | Type                                                              | Description                                            |
| -------------- | ----------------------------------------------------------------- | ------------------------------------------------------ |
| `opts?`        | \{ `offset?`: `number`; `limit?`: `number`; `name?`: `string`; \} | The options for the list operation.                    |
