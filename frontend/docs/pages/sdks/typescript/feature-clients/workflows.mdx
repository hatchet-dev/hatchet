...
| Parameter      | Type                                                                    | Description                                            |
| -------------- | ----------------------------------------------------------------------- | ------------------------------------------------------ |
| `opts?`        | \{ `limit?`: ... \| ...; `name?`: ... \| ...; `offset?`: ... \| ...; \} | The options for the list operation.                    |
| `opts.limit?`  | ... \| ...                                                              | The number to limit by **Format** int **Default** `50` |
| `opts.name?`   | ... \| ...                                                              | Search by name                                         |
| `opts.offset?` | ... \| ...                                                              | The number to skip **Format** int **Default** `0`      |
