...
| `cron`                     | \{ `additionalMetadata?`: `Record`\<..., ...\>; `expression`: `string`; `input?`: `Record`\<..., ...\>; `name`: `string`; `priority?`: `number`; \} | The input data for creating the Cron Trigger. |
| `cron.additionalMetadata?` | `Record`\<..., ...\>                                                                                                                                | -                                             |
