...
| --------- | --------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| `options` | `CreateDurableTaskWorkflowOpts`\<`I` & `Resolved`\<..., ...\>, `MergeIfNonEmpty`\<`O`, `GlobalOutput`\>\> | Durable task configuration options |
...
| Parameter | Type                                                                     | Description                                                         |
| --------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| `options` | `object` & `Omit`\<`CreateDurableTaskWorkflowOpts`\<..., ...\>, `"fn"`\> | Durable task configuration options with function that defines types |
...
| Parameter | Type                                                                                               | Description                |
| --------- | -------------------------------------------------------------------------------------------------- | -------------------------- |
| `options` | `CreateTaskWorkflowOpts`\<`I` & `Resolved`\<..., ...\>, `MergeIfNonEmpty`\<`O`, `GlobalOutput`\>\> | Task configuration options |
...
| Parameter | Type                                                              | Description                                                 |
| --------- | ----------------------------------------------------------------- | ----------------------------------------------------------- |
| `options` | `object` & `Omit`\<`CreateTaskWorkflowOpts`\<..., ...\>, `"fn"`\> | Task configuration options with function that defines types |
