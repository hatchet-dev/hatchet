...
A admin client instance

**Implementation of**

```ts
IHatchetClient.admin;
```
...
[`WorkflowDeclaration`](Runnables.mdx#workflowdeclaration)\<`I`, `O`\>
...
| Parameter | Type                                 | Description                |
| --------- | ------------------------------------ | -------------------------- |
| `options` | `CreateTaskWorkflowOpts`\<`I`, `O`\> | Task configuration options |

**Returns**

[`TaskWorkflowDeclaration`](Runnables.mdx#taskworkflowdeclaration)\<`I`, `O`\>
...
| Parameter | Type                                        | Description                        |
| --------- | ------------------------------------------- | ---------------------------------- |
| `options` | `CreateDurableTaskWorkflowOpts`\<`I`, `O`\> | Durable task configuration options |
