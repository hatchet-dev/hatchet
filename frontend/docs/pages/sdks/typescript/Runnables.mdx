...
| Parameter | Type                                                                                                                                           | Description                     |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| `options` | \| [`TaskWorkflowDeclaration`](#taskworkflowdeclaration)\<`any`, `any`\> \| `Omit`\<`CreateOnFailureTaskOpts`\<..., ...\>, `"fn"`\> & `object` | The task configuration options. |
...
| Parameter  | Type      | Description                                            |
| ---------- | --------- | ------------------------------------------------------ |
| `input`    | `I`       | The input payload for the task (single item or array). |
...
The task result for single input, or an array of results for array input.

**Throws**

Error if the task is not bound to a Hatchet client.
...
A `WorkflowRunRef` for single input, or an array of run refs for array input.
