...
that makes use of cooperative coprocessing. This means that when blocking non-async-safe functions
are added to the mix, it can cause issues and degrade the performance of the SDK.
...
- Can be used as a decorator or an inline wrapper
...
### Broad Resources for AsyncIO Development
