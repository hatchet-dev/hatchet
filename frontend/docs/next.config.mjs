...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/essentials/setup',
        destination: '/v1/setup/advanced',
        permanent: true,
        basePath: false,
      },
      {
        source: '/essentials/environments',
        destination: '/v1/setup/advanced/environments',
        permanent: true,
        basePath: false,
      },
      {
        source: '/v1/essentials/hatchet-cloud-quickstart',
        destination: '/v1/setup/quickstart',
        permanent: true,
        basePath: false,
      },
      {
        source: '/v1/essentials/hatchet-cloud-quickstart/advanced/setup',
        destination: '/v1/setup/advanced',
        permanent: true,
        basePath: false,
      },
      {
        source: '/essentials/hatchet-cloud-quickstart/advanced/setup',
        destination: '/v1/setup/advanced',
        permanent: true,
        basePath: false,
      },
      {
        source: '/essentials/hatchet-cloud-quickstart/setup',
        destination: '/v1/setup/advanced',
        permanent: true,
        basePath: false,
      },
      {
        source: '/essentials/hatchet-cloud-quickstart/environments',
        destination: '/v1/setup/advanced/environments',
        permanent: true,
        basePath: false,
      },
      {
        source: '/v1/essentials/hatchet-cloud-quickstart/advanced',
        destination: '/v1/setup/advanced',
        permanent: true,
        basePath: false,
      },
      {
        source: '/v1/essentials/hatchet-cloud-quickstart/advanced/environments',
        destination: '/v1/setup/advanced/environments',
        permanent: true,
        basePath: false,
      },
      {
        source: '/v1/essentials/hatchet-cloud-quickstart/coding-agents',
      ...
      {
        source: '/compute',
        destination: '/v1/essentials/compute',
        permanent: true,
        basePath: false,
      },
      {
      ...
      },
      {
        ...
        destination: "/v1/essentials/your-first-task",
        permanent: false,
        basePath: false,
      },
      {
      ...
      },
      {
        ...
        destination: "/v1/essentials/:path*",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/patterns",
        destination: "/v1/patterns/fanout",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/patterns/:path*",
        destination: "/v1/patterns/:path*",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/use-cases",
        destination: "/v1/patterns/rag-and-indexing",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/use-cases/:path*",
        destination: "/v1/patterns/:path*",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/v1-sdk-improvements",
        destination: "/v1/migrating/v0-to-v1/v1-sdk-improvements",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/migration-guide-engine",
        destination: "/v1/migrating/v0-to-v1/migration-guide-engine",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/migration-guide-python",
        destination: "/v1/migrating/v0-to-v1/migration-guide-python",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/migration-guide-typescript",
        destination: "/v1/migrating/v0-to-v1/migration-guide-typescript",
        permanent: false,
        basePath: false,
      },
      {
        source: "/essentials/migration-guide-go",
      ...
      {
        source: '/:path((?!api|ingest|v1|v0|compute|home|essentials|features|patterns|migrating|cli|sdk|sdks|contributing|self-hosting|launches|blog|llms|pages|favicon\\.ico|.*\\.png|.*\\.gif|.*\\.svg|_next/.*|monitoring\\-demo\\.mp4).*)',
        destination: '/v1/essentials/:path*',
        permanent: false,
        basePath: false,
      },
