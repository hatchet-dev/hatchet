...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/:path((?!api|ingest|v1|v0|compute|home|get-started|features|guides|migrating|cli|sdk|sdks|contributing|self-hosting|launches|blog|llms|pages|favicon\\.ico|.*\\.png|.*\\.gif|.*\\.svg|_next/.*|monitoring\\-demo\\.mp4).*)',
        destination: '/v1/get-started/:path*',
        permanent: false,
        basePath: false,
      },
