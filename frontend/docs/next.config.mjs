  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: "/v1/concepts/durable-workflows/durable-task-execution/child-spawning",
        permanent: false,
        basePath: false,
      },
      {
        source: "/get-started/patterns/long-waits",
        destination: "/v1/concepts/durable-workflows/durable-task-execution/durable-sleep",
        permanent: false,
        basePath: false,
      },
      {
        source: "/get-started/patterns/:path*",
        destination: "/v1/concepts/durable-workflows/:path*",
        permanent: false,
        basePath: false,
      },
      {
