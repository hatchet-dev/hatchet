 ...
 async rewrites() {
  ...
  async redirects() {
    return [
      ...
      { source: '/', destination: '/v1', permanent: true, basePath: false },
      { source: '/get-started', destination: '/v1', permanent: true, basePath: false },
      { source: '/v1/migrating', destination: '/v1/migrating/v1-sdk-improvements', permanent: true, basePath: false },
      { source: '/v1/migrating/', destination: '/v1/migrating/v1-sdk-improvements', permanent: true, basePath: false },
      { source: '/agent-instructions', destination: '/agent-instructions/setup-cli', permanent: true, basePath: false },
      { source: '/agent-instructions/', destination: '/agent-instructions/setup-cli', permanent: true, basePath: false },
      { source: '/reference/typescript/feature-clients', destination: '/reference/typescript/feature-clients/crons', permanent: true, basePath: false },
      { source: '/reference/typescript/feature-clients/', destination: '/reference/typescript/feature-clients/crons', permanent: true, basePath: false },
      { source: '/reference/python/feature-clients', destination: '/reference/python/feature-clients/cron', permanent: true, basePath: false },
      { source: '/reference/python/feature-clients/', destination: '/reference/python/feature-clients/cron', permanent: true, basePath: false },
      { source: '/reference/go/feature-clients', destination: '/reference/go/feature-clients/crons', permanent: true, basePath: false },
      { source: '/reference/go/feature-clients/', destination: '/reference/go/feature-clients/crons', permanent: true, basePath: false },
      { source: '/reference/ruby/feature-clients', destination: '/reference/ruby/feature-clients/cron', permanent: true, basePath: false },
      { source: '/reference/ruby/feature-clients/', destination: '/reference/ruby/feature-clients/cron', permanent: true, basePath: false },
      ...
      { source: '/v1/durable-tasks-vs-dags', destination: '/cookbooks/durable-tasks-vs-dags', permanent: true, basePath: false },
      ...
      { source: '/home/setup', destination: '/v1/quickstart', permanent: true, basePath: false },
      ...
      { source: '/home/basics/overview', destination: '/v1/quickstart', permanent: true, basePath: false },
      { source: '/home/basics/(steps|workflows)', destination: '/v1/tasks', permanent: true, basePath: false },
      { source: '/home/basics/environments', destination: '/v1/environments', permanent: true, basePath: false },
      ...
      { source: '/home', destination: '/v1', permanent: true, basePath: false },
      { source: '/home/:path*', destination: '/v1/:path*', permanent: true, basePath: false },
      // --- /v1/setup/* was linked from old redirects but never existed on the new site ---
      { source: '/v1/setup/advanced/environments', destination: '/v1/environments', permanent: true, basePath: false },
      { source: '/v1/setup/:path*', destination: '/v1/quickstart', permanent: true, basePath: false },
      // --- Duplicate copies of guide pages that lived under /v1/advanced-tasks and /v1/error-handling ---
      { source: '/v1/advanced-tasks', destination: '/v1/tasks', permanent: true, basePath: false },
      { source: '/v1/advanced-tasks/:slug', destination: '/v1/:slug', permanent: true, basePath: false },
      { source: '/v1/error-handling/:slug', destination: '/v1/:slug', permanent: true, basePath: false },
      ...
      { source: '/sdks/python-sdk/:path*', destination: '/reference/python/client', permanent: true, basePath: false },
      { source: '/sdks/python', destination: '/reference/python/client', permanent: true, basePath: false },
      { source: '/sdks/:path*', destination: '/reference/:path*', permanent: true, basePath: false },
      { source: '/sdk/:path*', destination: '/reference/:path*', permanent: true, basePath: false },
      { source: '/cli/:path*', destination: '/reference/cli/:path*', permanent: true, basePath: false },
