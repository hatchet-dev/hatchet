...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/:path((?!api|ingest|v1|v0|compute|home|guide|features|cli|sdk|sdks|contributing|self-hosting|launches|blog|llms|favicon\\.ico|.*\\.png|.*\\.gif|.*\\.svg|_next/.*|monitoring\\-demo\\.mp4).*)',
        destination: '/v1/guide/:path*',
        permanent: false,
        basePath: false,
      },
