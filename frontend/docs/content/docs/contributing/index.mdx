---
title: "Contributing"
description: "How to set up a local Hatchet development environment, run the engine, API, and dashboard from source, and contribute changes back to the project."
---
