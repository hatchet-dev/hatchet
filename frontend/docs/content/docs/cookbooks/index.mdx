...
<Cards>
  ...
  <Cards.Card title="Amazon S3 Processor" href="/cookbooks/workflow-aws-s3">
...
<Cards>
  ...
  <Cards.Card
    ...
    href="/cookbooks/hatchet-claude-agent-sdk-trusted-env"
  >
  ...
  <Cards.Card
    ...
    href="/cookbooks/hatchet-openai-agents-sdk-trusted-env"
  >
    Use the OpenAI Agents SDK with Hatchet-backed tools in a trusted
    environment.
  </Cards.Card>
  <Cards.Card title="Pi Agent Sessions" href="/cookbooks/pi-agent-sessions">
    Run Pi agent turns as Hatchet child tasks, with a durable task that carries
    session state across user-message events.
  </Cards.Card>
</Cards>
