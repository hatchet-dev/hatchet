...
title: "Quickstart"
asIndexPage: true
seoTitle: "Hatchet Cloud Quickstart"
---

import { snippets } from "@/lib/generated/snippets";
import { Snippet } from "@/components/code";
import { Callout, Card, Cards, Steps } from "@/components/nextra-compat";
...
<Callout type="info">
  This guide walks you through getting set up on Hatchet Cloud. If you'd like to
  self-host Hatchet, please see the [self-hosted quickstart](/self-hosting)
  instead.
</Callout>

<Callout type="info">
  **Just developing locally?** You can run Hatchet on your own machine, with no
...
### (Optional) Set up AI coding agents

Add the local Hatchet MCP server to your AI coding agents (Claude Code, Cursor, VS Code, Codex), so they can trigger runs, inspect results, and debug workers:
...
See the [full setup guide](/v1/using-coding-agents) for details.
