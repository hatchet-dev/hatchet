...
<Snippet src={snippets.go.rate_limiting.main.dynamic_rate_limit} />

  </Tabs.Tab>
  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.rate_limit.worker.dynamic} />
  </Tabs.Tab>
</UniversalTabs>
...
<Snippet src={snippets.typescript.rate_limit.workflow.upsert_rate_limit} />
  ...
  <Tabs.Tab>
    ...
    <Snippet src={snippets.go.rate_limiting.main.upsert_rate_limit} />

  </Tabs.Tab>

  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.rate_limit.worker.create_a_rate_limit} />
  </Tabs.Tab>
</UniversalTabs>
...
<Snippet src={snippets.typescript.rate_limit.workflow.static} />
  ...
  <Tabs.Tab>
    <Snippet src={snippets.go.rate_limiting.main.static_rate_limit} />

  </Tabs.Tab>
  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.rate_limit.worker.static} />
  </Tabs.Tab>
</UniversalTabs>
