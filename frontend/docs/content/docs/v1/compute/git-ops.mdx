...
3. **Github Branch**
   ...
   - Note: You can configure Dev/Prod branches to deploy to different services with [namespaces or tenants](/v1/environments)
...
Your Dockerfile needs to be properly configured to run Hatchet workers. See our [Docker configuration guide](/v1/docker) for:
