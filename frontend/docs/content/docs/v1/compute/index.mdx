...
- **[Multi-Region Support](./compute/cpu#available-regions)**: Deploy across regions for fault tolerance and data locality
- **[Auto-Scaling](./compute/auto-scaling)**: Automatically scale your compute resources based on workload demand

### Available Compute Classes

- [Shared CPUs](./compute/cpu#shared-cpu)
- [Performance CPUs](./compute/cpu#performance-cpu)
- [GPU instances](./compute/gpu)
...
- **[GitOps Integration](./compute/git-ops)**: Automatic builds and deployments on commit
