---
title: "DAGs as Durable Workflows"
---
...
import { DagFanout } from "@/components/flow-animations/DagFanout";
import { DagPipeline } from "@/components/flow-animations/DagPipeline";
...
<UniversalTabs items={["Python", "Typescript"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snippets.python.conditions.worker.add_multiple_or_groups} />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={
        snippets.typescript.dag_match_condition.complex_workflow
          .add_multiple_or_groups
      }
    />
  </Tabs.Tab>
</UniversalTabs>
