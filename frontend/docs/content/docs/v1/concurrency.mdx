...
import { HeadOfLineBlocking } from "@/components/flow-animations/HeadOfLineBlocking";
import { FairQueueing } from "@/components/flow-animations/FairQueueing";
...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  <Tabs.Tab title="Python">
    <Snippet
      src={
        snippets.python.concurrency_cancel_queued_except_newest.worker
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={
        snippets.typescript.concurrency_cancel_queued_except_newest.workflow
          .cancel_queued_except_newest
      }
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.concurrency.main.cancel_queued_except_newest} />
  </Tabs.Tab>
  <Tabs.Tab title="Ruby">
    <Snippet
      src={
        snippets.ruby.concurrency_cancel_queued_except_newest.worker
          .cancel_queued_except_newest
      }
    />
  </Tabs.Tab>
...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  <Tabs.Tab title="Python">
    <Snippet
      src={
        snippets.python.concurrency_cancel_queued_except_oldest.worker
  ...
  <Tabs.Tab title="Typescript">
    <Snippet
      src={
        snippets.typescript.concurrency_cancel_queued_except_oldest.workflow
          .cancel_queued_except_oldest
      }
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.concurrency.main.cancel_queued_except_oldest} />
  </Tabs.Tab>
  <Tabs.Tab title="Ruby">
    <Snippet
      src={
        snippets.ruby.concurrency_cancel_queued_except_oldest.worker
          .cancel_queued_except_oldest
      }
    />
  </Tabs.Tab>
...
<Callout type="info">
  Shared concurrency strategies require engine version 0.106.0 or greater.
</Callout>
...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  <Tabs.Tab title="Python">
    <Snippet
      src={
        snippets.python.concurrency_shared.worker.shared_concurrency_strategy
      }
    />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={
        snippets.typescript.concurrency_shared.workflow
          .shared_concurrency_strategy
      }
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.concurrency.main.shared_concurrency_strategy} />
  </Tabs.Tab>
  <Tabs.Tab title="Ruby">
    <Snippet
      src={snippets.ruby.concurrency_shared.worker.shared_concurrency_strategy}
    />
  </Tabs.Tab>
</UniversalTabs>
...
<Callout type="warning">
  When multiple workflows chain the same shared strategies, they must order
...
<Callout type="info">
  Max runs expressions require engine version 0.106.0 or greater.
</Callout>
...
<UniversalTabs items={["Python", "Typescript", "Go", "Ruby"]}>
  <Tabs.Tab title="Python">
    <Snippet
      src={snippets.python.concurrency_dynamic.worker.dynamic_max_runs}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snippets.typescript.concurrency_dynamic.workflow.dynamic_max_runs}
    />
  </Tabs.Tab>
  <Tabs.Tab title="Go">
    <Snippet src={snippets.go.concurrency.main.dynamic_max_runs} />
  </Tabs.Tab>
  <Tabs.Tab title="Ruby">
    <Snippet src={snippets.ruby.concurrency_dynamic.worker.dynamic_max_runs} />
  </Tabs.Tab>
</UniversalTabs>
