...
The Python SDK has a number of notable highlights to showcase for V1. Many of them have been highlighted elsewhere, such as [in the migration guide](/v1/migrating/migration-guide-python), on the [Pydantic page](/reference/python/pydantic), an in various examples. Here, we'll list out each of them, along with their motivations and benefits.
...
1. External-facing protobuf objects, such as `StickyStrategy`, have been replaced by native Python enums to make working with them easier. Concurrency strategies are passed as a plain string `Literal` on `ConcurrencyStrategy` rather than a separate enum type.
...
The Typescript SDK has a number of notable highlights to showcase for V1. Many of them have been highlighted elsewhere, such as [in the migration guide](/v1/migrating/migration-guide-typescript), an in various examples. Here, we'll list out each of them, along with their motivations and benefits.
...
The Go SDK has a number of notable highlights to showcase for V1. Many of them have been highlighted elsewhere, such as [in the migration guide](/v1/migrating/migration-guide-go), an in various examples. Here, we'll list out each of them, along with their motivations and benefits.
