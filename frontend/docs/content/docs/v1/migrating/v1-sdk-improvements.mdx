...
description: "What changed in the Hatchet v1 SDKs compared to v0: simpler task and workflow definitions, typed inputs and outputs, and consistent async APIs."
---
