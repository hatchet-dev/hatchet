...
The Python SDK has a number of notable highlights to showcase for V1. Many of them have been highlighted elsewhere, such as [in the migration guide](./migration-guide-python), on the [Pydantic page](/reference/python/pydantic), an in various examples. Here, we'll list out each of them, along with their motivations and benefits.
...
The Typescript SDK has a number of notable highlights to showcase for V1. Many of them have been highlighted elsewhere, such as [in the migration guide](./migration-guide-typescript), an in various examples. Here, we'll list out each of them, along with their motivations and benefits.
...
The Go SDK has a number of notable highlights to showcase for V1. Many of them have been highlighted elsewhere, such as [in the migration guide](./migration-guide-go), an in various examples. Here, we'll list out each of them, along with their motivations and benefits.
