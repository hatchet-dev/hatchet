...
description: "Sticky assignment pins every child task of a workflow run to the worker that ran the parent, so expensive local state can be reused across tasks."
---
