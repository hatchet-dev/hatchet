---
title: "Generating Quickstart Projects"
---
...
The generated project contains a worker, a workflow, a trigger script, and a `hatchet.yaml` for [`hatchet worker dev`](/reference/cli/running-workers-locally). The worker runs in your environment and connects to your Hatchet instance using the profile you have configured.
