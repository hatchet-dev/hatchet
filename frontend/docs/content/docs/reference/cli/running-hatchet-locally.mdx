...
seoTitle: "Running Hatchet Locally with the CLI"
---

# Running Hatchet Locally with the CLI
...
For other ways to run Hatchet locally, including embedded mode with no Docker at all, see [Running Hatchet Locally](/v1/running-locally).
