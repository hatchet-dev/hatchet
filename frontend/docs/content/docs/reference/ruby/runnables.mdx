...
| Type                                                                                                   | Description                 |
| ------------------------------------------------------------------------------------------------------ | --------------------------- |
| `Array<ConcurrencyExpression, SharedConcurrency> \| ConcurrencyExpression \| SharedConcurrency \| nil` | Workflow-level concurrency. |
...
| `concurrency`           | `ConcurrencyExpression \| SharedConcurrency \| Array<ConcurrencyExpression, SharedConcurrency> \| nil` | A concurrency expression (or list of them) controlling the concurrency settings for this task.     | `nil`      |
...
| Type                                                                                                   | Description             |
| ------------------------------------------------------------------------------------------------------ | ----------------------- |
| `Array<ConcurrencyExpression, SharedConcurrency> \| ConcurrencyExpression \| SharedConcurrency \| nil` | Task-level concurrency. |
