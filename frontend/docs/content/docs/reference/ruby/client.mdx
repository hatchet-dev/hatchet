...
| `opts`            | `Hash`                                                             | Any other task options (`retries:`, `execution_timeout:`, `concurrency:`, and so on) are forwarded to the task declaration - see `Workflow#task` for the full list. | `{}`       |
...
| `opts`            | `Hash`                           | Any other task options forwarded to the task declaration.                                                                                                                                             | `{}`                                            |
...
| `opts`  | `Hash`                     | Any other task options (`on_events:`, `idempotency:`, and so on)         | `{}`       |
