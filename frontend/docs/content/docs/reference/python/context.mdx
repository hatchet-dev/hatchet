...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `increment_by` | `timedelta` | The amount of time to increment the timeout by. Can be a string (e.g. "5m") or a timedelta object. | *required* |
...
| Name | Type | Description | Default |
| --- | --- | --- | --- |
| `duration` | `timedelta` | The duration to sleep for. Should be a timedelta object. | *required* |
