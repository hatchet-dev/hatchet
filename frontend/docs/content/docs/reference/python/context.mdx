...
| `refresh_timeout` | Refresh the timeout for the current task run. You can read about refreshing timeouts in [the docs](/v1/timeouts#refreshing-timeouts).                                    |
...
The worker lifespan, if it exists. You can read about lifespans in [the docs](/reference/python/lifespans).
...
| Type               | Description                                                           |
| ------------------ | --------------------------------------------------------------------- |
| `Priority \| None` | The priority of the current task run, or None if no priority was set. |
...
Refresh the timeout for the current task run. You can read about refreshing timeouts in [the docs](/v1/timeouts#refreshing-timeouts).

Parameters:

| Name           | Type        | Description                                                                                        | Default    |
| -------------- | ----------- | -------------------------------------------------------------------------------------------------- | ---------- |
| `increment_by` | `timedelta` | The amount of time to increment the timeout by. Can be a string (e.g. "5m") or a timedelta object. | _required_ |
...
| Type                                                         | Description                                      |
| ------------------------------------------------------------ | ------------------------------------------------ |
| `list[SleepResult \| EventWaitResult[Any] \| OrGroupResult]` | A dictionary containing the results of the wait. |
...
| Name       | Type          | Description                                                                                                                                                  | Default    |
| ---------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| `duration` | `timedelta`   | The duration to sleep for. Should be a timedelta object.                                                                                                     | _required_ |
