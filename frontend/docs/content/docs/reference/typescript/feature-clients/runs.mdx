...
| Parameter | Type                                | Description                                       |
| --------- | ----------------------------------- | ------------------------------------------------- |
| `run`     | `string` \| `WorkflowRunRef`\<`T`\> | The workflow run ID (string) or a WorkflowRunRef. |

Returns

`Promise`\<[`RunDetail`](#rundetail)\>
...
<a id="taskrundetail"></a>

### TaskRunDetail

```ts
type TaskRunDetail = object;
```
...
| ----------------------------------- | --------- | ------------------------------------------------------------------------------------------------- |
| <a id="output"></a> `output`        | `unknown` | The output decoded as JSON; `null` when the task stored nothing, `null` or text that is not JSON. |
| <a id="rawoutput"></a> `rawOutput?` | `string`  | The output text as the engine stored it; absent when the task stored nothing.                     |
