...
[`CronClient`](feature-clients/crons#cronclient)
...
[`FiltersClient`](feature-clients/filters#filtersclient)
...
[`LogsClient`](feature-clients/logs#logsclient)
...
[`MetricsClient`](feature-clients/metrics#metricsclient)
...
[`RatelimitsClient`](feature-clients/ratelimits#ratelimitsclient)
...
[`RunsClient`](feature-clients/runs#runsclient)
...
[`ScheduleClient`](feature-clients/schedules#scheduleclient)
...
[`WorkflowsClient`](feature-clients/workflows#workflowsclient)
...
[`TenantClient`](feature-clients/tenant#tenantclient)
...
[`WebhooksClient`](feature-clients/webhooks#webhooksclient)
...
[`WorkersClient`](feature-clients/workers#workersclient)
...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| `options` | [`CreateBatchTaskWorkflowOpts`](runnables#createbatchtaskworkflowopts)\<`I` & `Resolved`\<`GlobalInput`, `MiddlewareBefore`\>, `MergeIfNonEmpty`\<`O`, `GlobalOutput`\>\> | Batch task configuration options |

Returns

[`TaskWorkflowDeclaration`](runnables#taskworkflowdeclaration)\<`I`, `O`, `GlobalInput`, `GlobalOutput`, `MiddlewareBefore`, `MiddlewareAfter`\>
...
| Parameter | Type                                                                                                                         | Description                                                       |
| --------- | ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| `options` | `object` & `Omit`\<[`CreateBatchTaskWorkflowOpts`](runnables#createbatchtaskworkflowopts)\<`I`, `O`\>, `"batch"` \| `"fn"`\> | Batch task configuration options with function that defines types |
...
[`WorkflowDeclaration`](runnables#workflowdeclaration)\<`I`, `O`, `Resolved`\<`GlobalInput`, `MiddlewareBefore`\>\>
